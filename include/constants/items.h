...
enum __attribute__((packed)) Item
{
    ...
    // Evolution Items
    ITEM_FIRE_STONE = 211,
    ITEM_EVO_CARD_RED = ITEM_FIRE_STONE,
    ITEM_WATER_STONE = 212,
    ITEM_EVO_CARD_BLUE = ITEM_WATER_STONE,
    ITEM_THUNDER_STONE = 213,
    ITEM_THUNDERSTONE = ITEM_THUNDER_STONE, // Pre-Gen VI name
    ITEM_EVO_CARD_YELLOW = ITEM_THUNDER_STONE,
    ITEM_LEAF_STONE = 214,
    ITEM_EVO_CARD_GREEN = ITEM_LEAF_STONE,
    ITEM_ICE_STONE = 215,
    ITEM_EVO_CARD_CYAN = ITEM_ICE_STONE,
    ITEM_SUN_STONE = 216,
    ITEM_EVO_CARD_WHITE = ITEM_SUN_STONE,
    ITEM_MOON_STONE = 217,
    ITEM_EVO_CARD_BLACK = ITEM_MOON_STONE,
    ITEM_SHINY_STONE = 218,
    ITEM_EVO_CARD_CLEAR = ITEM_SHINY_STONE,
    ITEM_DUSK_STONE = 219,
    ITEM_EVO_CARD_PURPLE = ITEM_DUSK_STONE,
    ITEM_DAWN_STONE = 220,
    ITEM_EVO_CARD_ORANGE = ITEM_DAWN_STONE,
    ...
    LAST_ITEM_OFFICIAL_EXPANSION = ITEM_GLIMMORANITE,
    // Touhou
    ITEM_MEMORY_SHARD_G1 = (LAST_ITEM_OFFICIAL_EXPANSION + 1),
    ITEM_MEMORY_SHARD_G2 = (LAST_ITEM_OFFICIAL_EXPANSION + 2),
    ITEM_MEMORY_SHARD_G3 = (LAST_ITEM_OFFICIAL_EXPANSION + 3),
    ITEM_MEMORY_SHARD_G4 = (LAST_ITEM_OFFICIAL_EXPANSION + 4),
    ITEM_MEMORY_SHARD_G5 = (LAST_ITEM_OFFICIAL_EXPANSION + 5),
    ITEM_MEMORY_SHARD_G6 = (LAST_ITEM_OFFICIAL_EXPANSION + 6),
    ITEM_MEMORY_SHARD_G7 = (LAST_ITEM_OFFICIAL_EXPANSION + 7),
    ITEM_MEMORY_SHARD_G8 = (LAST_ITEM_OFFICIAL_EXPANSION + 8),
    ITEM_MEMORY_SHARD_G9 = (LAST_ITEM_OFFICIAL_EXPANSION + 9),
    ITEM_GENSOKYO_MEMORY = (LAST_ITEM_OFFICIAL_EXPANSION + 10),
    // YuYuYui
    ITEM_MEMORY_SHARD_H1 = (LAST_ITEM_OFFICIAL_EXPANSION + 11),
    ITEM_MEMORY_SHARD_H2 = (LAST_ITEM_OFFICIAL_EXPANSION + 12),
    ITEM_MEMORY_SHARD_H3 = (LAST_ITEM_OFFICIAL_EXPANSION + 13),
    ITEM_MEMORY_SHARD_H4 = (LAST_ITEM_OFFICIAL_EXPANSION + 14),
    ITEM_MEMORY_SHARD_H5 = (LAST_ITEM_OFFICIAL_EXPANSION + 15),
    ITEM_MEMORY_SHARD_H6 = (LAST_ITEM_OFFICIAL_EXPANSION + 16),
    ITEM_MEMORY_SHARD_H7 = (LAST_ITEM_OFFICIAL_EXPANSION + 17),
    ITEM_MEMORY_SHARD_H8 = (LAST_ITEM_OFFICIAL_EXPANSION + 18),
    ITEM_MEMORY_SHARD_H9 = (LAST_ITEM_OFFICIAL_EXPANSION + 19),
    ITEM_HERO_MEMORY = (LAST_ITEM_OFFICIAL_EXPANSION + 20),
    // Key
    ITEM_MEMORY_SHARD_K1 = (LAST_ITEM_OFFICIAL_EXPANSION + 21),
    ITEM_MEMORY_SHARD_K2 = (LAST_ITEM_OFFICIAL_EXPANSION + 22),
    ITEM_MEMORY_SHARD_K3 = (LAST_ITEM_OFFICIAL_EXPANSION + 23),
    ITEM_MEMORY_SHARD_K4 = (LAST_ITEM_OFFICIAL_EXPANSION + 24),
    ITEM_MEMORY_SHARD_K5 = (LAST_ITEM_OFFICIAL_EXPANSION + 25),
    ITEM_MEMORY_SHARD_K6 = (LAST_ITEM_OFFICIAL_EXPANSION + 26),
    ITEM_MEMORY_SHARD_K7 = (LAST_ITEM_OFFICIAL_EXPANSION + 27),
    ITEM_MEMORY_SHARD_K8 = (LAST_ITEM_OFFICIAL_EXPANSION + 28),
    ITEM_MEMORY_SHARD_K9 = (LAST_ITEM_OFFICIAL_EXPANSION + 29),
    ITEM_KEY_MEMORY = (LAST_ITEM_OFFICIAL_EXPANSION + 30),
    // Precure
    ITEM_MEMORY_SHARD_C1 = (LAST_ITEM_OFFICIAL_EXPANSION + 31),
    ITEM_MEMORY_SHARD_C2 = (LAST_ITEM_OFFICIAL_EXPANSION + 32),
    ITEM_MEMORY_SHARD_C3 = (LAST_ITEM_OFFICIAL_EXPANSION + 33),
    ITEM_MEMORY_SHARD_C4 = (LAST_ITEM_OFFICIAL_EXPANSION + 34),
    ITEM_MEMORY_SHARD_C5 = (LAST_ITEM_OFFICIAL_EXPANSION + 35),
    ITEM_MEMORY_SHARD_C6 = (LAST_ITEM_OFFICIAL_EXPANSION + 36),
    ITEM_MEMORY_SHARD_C7 = (LAST_ITEM_OFFICIAL_EXPANSION + 37),
    ITEM_MEMORY_SHARD_C8 = (LAST_ITEM_OFFICIAL_EXPANSION + 38),
    ITEM_MEMORY_SHARD_C9 = (LAST_ITEM_OFFICIAL_EXPANSION + 39),
    ITEM_CURE_MEMORY = (LAST_ITEM_OFFICIAL_EXPANSION + 40),
    // BGHS
    ITEM_MEMORY_SHARD_B1 = (LAST_ITEM_OFFICIAL_EXPANSION + 41),
    ITEM_MEMORY_SHARD_B2 = (LAST_ITEM_OFFICIAL_EXPANSION + 42),
    ITEM_MEMORY_SHARD_B3 = (LAST_ITEM_OFFICIAL_EXPANSION + 43),
    ITEM_MEMORY_SHARD_B4 = (LAST_ITEM_OFFICIAL_EXPANSION + 44),
    ITEM_MEMORY_SHARD_B5 = (LAST_ITEM_OFFICIAL_EXPANSION + 45),
    ITEM_MEMORY_SHARD_B6 = (LAST_ITEM_OFFICIAL_EXPANSION + 46),
    ITEM_MEMORY_SHARD_B7 = (LAST_ITEM_OFFICIAL_EXPANSION + 47),
    ITEM_MEMORY_SHARD_B8 = (LAST_ITEM_OFFICIAL_EXPANSION + 48),
    ITEM_MEMORY_SHARD_B9 = (LAST_ITEM_OFFICIAL_EXPANSION + 49),
    ITEM_BATTLE_MEMORY = (LAST_ITEM_OFFICIAL_EXPANSION + 50),
    // Moemon
    ITEM_MEMORY_SHARD_M1 = (LAST_ITEM_OFFICIAL_EXPANSION + 51),
    ITEM_MEMORY_SHARD_M2 = (LAST_ITEM_OFFICIAL_EXPANSION + 52),
    ITEM_MEMORY_SHARD_M3 = (LAST_ITEM_OFFICIAL_EXPANSION + 53),
    ITEM_MEMORY_SHARD_M4 = (LAST_ITEM_OFFICIAL_EXPANSION + 54),
    ITEM_MEMORY_SHARD_M5 = (LAST_ITEM_OFFICIAL_EXPANSION + 55),
    ITEM_MEMORY_SHARD_M6 = (LAST_ITEM_OFFICIAL_EXPANSION + 56),
    ITEM_MEMORY_SHARD_M7 = (LAST_ITEM_OFFICIAL_EXPANSION + 57),
    ITEM_MEMORY_SHARD_M8 = (LAST_ITEM_OFFICIAL_EXPANSION + 58),
    ITEM_MEMORY_SHARD_M9 = (LAST_ITEM_OFFICIAL_EXPANSION + 59),
    ITEM_ANOTHER_MEMORY = (LAST_ITEM_OFFICIAL_EXPANSION + 60),
    // Others
    ITEM_MEMORY_SHARD_X1 = (LAST_ITEM_OFFICIAL_EXPANSION + 61),
    ITEM_MEMORY_SHARD_X2 = (LAST_ITEM_OFFICIAL_EXPANSION + 62),
    ITEM_MEMORY_SHARD_X3 = (LAST_ITEM_OFFICIAL_EXPANSION + 63),
    ITEM_MEMORY_SHARD_X4 = (LAST_ITEM_OFFICIAL_EXPANSION + 64),
    ITEM_MEMORY_SHARD_X5 = (LAST_ITEM_OFFICIAL_EXPANSION + 65),
    ITEM_MEMORY_SHARD_X6 = (LAST_ITEM_OFFICIAL_EXPANSION + 66),
    ITEM_MEMORY_SHARD_X7 = (LAST_ITEM_OFFICIAL_EXPANSION + 67),
    ITEM_MEMORY_SHARD_X8 = (LAST_ITEM_OFFICIAL_EXPANSION + 68),
    ITEM_MEMORY_SHARD_X9 = (LAST_ITEM_OFFICIAL_EXPANSION + 69),
    ITEM_EXTRA_MEMORY = (LAST_ITEM_OFFICIAL_EXPANSION + 70),
    // Shard of Dream
    ITEM_SHARD_OF_DREAM = (LAST_ITEM_OFFICIAL_EXPANSION + 71),
    // Biboo
    ITEM_TOPAZ = (LAST_ITEM_OFFICIAL_EXPANSION + 72),
    ITEM_AMETHYST = (LAST_ITEM_OFFICIAL_EXPANSION + 73),
    ITEM_EMERALD = (LAST_ITEM_OFFICIAL_EXPANSION + 74),
    ITEM_DIAMOND = (LAST_ITEM_OFFICIAL_EXPANSION + 75),
    ITEM_PEARL_GEMSTONE = (LAST_ITEM_OFFICIAL_EXPANSION + 76),
    ITEM_EMOTION_STONE = (LAST_ITEM_OFFICIAL_EXPANSION + 77),
    // Anya
    ITEM_ANCIENT_KRIS = (LAST_ITEM_OFFICIAL_EXPANSION + 78),
    ITEM_7_FLOWERS = (LAST_ITEM_OFFICIAL_EXPANSION + 79),
