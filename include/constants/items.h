...
#define LAST_ITEM_OFFICIAL_EXPANSION ITEM_GLIMMORANITE
// Touhou
#define ITEM_MEMORY_SHARD_G1         (LAST_ITEM_OFFICIAL_EXPANSION + 1)
#define ITEM_MEMORY_SHARD_G2         (LAST_ITEM_OFFICIAL_EXPANSION + 2)
#define ITEM_MEMORY_SHARD_G3         (LAST_ITEM_OFFICIAL_EXPANSION + 3)
#define ITEM_MEMORY_SHARD_G4         (LAST_ITEM_OFFICIAL_EXPANSION + 4)
#define ITEM_MEMORY_SHARD_G5         (LAST_ITEM_OFFICIAL_EXPANSION + 5)
#define ITEM_MEMORY_SHARD_G6         (LAST_ITEM_OFFICIAL_EXPANSION + 6)
#define ITEM_MEMORY_SHARD_G7         (LAST_ITEM_OFFICIAL_EXPANSION + 7)
#define ITEM_MEMORY_SHARD_G8         (LAST_ITEM_OFFICIAL_EXPANSION + 8)
#define ITEM_MEMORY_SHARD_G9         (LAST_ITEM_OFFICIAL_EXPANSION + 9)
#define ITEM_GENSOKYO_MEMORY         (LAST_ITEM_OFFICIAL_EXPANSION + 10)
// YuYuYui
#define ITEM_MEMORY_SHARD_H1         (LAST_ITEM_OFFICIAL_EXPANSION + 11)
#define ITEM_MEMORY_SHARD_H2         (LAST_ITEM_OFFICIAL_EXPANSION + 12)
#define ITEM_MEMORY_SHARD_H3         (LAST_ITEM_OFFICIAL_EXPANSION + 13)
#define ITEM_MEMORY_SHARD_H4         (LAST_ITEM_OFFICIAL_EXPANSION + 14)
#define ITEM_MEMORY_SHARD_H5         (LAST_ITEM_OFFICIAL_EXPANSION + 15)
#define ITEM_MEMORY_SHARD_H6         (LAST_ITEM_OFFICIAL_EXPANSION + 16)
#define ITEM_MEMORY_SHARD_H7         (LAST_ITEM_OFFICIAL_EXPANSION + 17)
#define ITEM_MEMORY_SHARD_H8         (LAST_ITEM_OFFICIAL_EXPANSION + 18)
#define ITEM_MEMORY_SHARD_H9         (LAST_ITEM_OFFICIAL_EXPANSION + 19)
#define ITEM_HERO_MEMORY             (LAST_ITEM_OFFICIAL_EXPANSION + 20)
// Key
#define ITEM_MEMORY_SHARD_K1         (LAST_ITEM_OFFICIAL_EXPANSION + 21)
#define ITEM_MEMORY_SHARD_K2         (LAST_ITEM_OFFICIAL_EXPANSION + 22)
#define ITEM_MEMORY_SHARD_K3         (LAST_ITEM_OFFICIAL_EXPANSION + 23)
#define ITEM_MEMORY_SHARD_K4         (LAST_ITEM_OFFICIAL_EXPANSION + 24)
#define ITEM_MEMORY_SHARD_K5         (LAST_ITEM_OFFICIAL_EXPANSION + 25)
#define ITEM_MEMORY_SHARD_K6         (LAST_ITEM_OFFICIAL_EXPANSION + 26)
#define ITEM_MEMORY_SHARD_K7         (LAST_ITEM_OFFICIAL_EXPANSION + 27)
#define ITEM_MEMORY_SHARD_K8         (LAST_ITEM_OFFICIAL_EXPANSION + 28)
#define ITEM_MEMORY_SHARD_K9         (LAST_ITEM_OFFICIAL_EXPANSION + 29)
#define ITEM_KEY_MEMORY              (LAST_ITEM_OFFICIAL_EXPANSION + 30)
// Precure
#define ITEM_MEMORY_SHARD_C1         (LAST_ITEM_OFFICIAL_EXPANSION + 31)
#define ITEM_MEMORY_SHARD_C2         (LAST_ITEM_OFFICIAL_EXPANSION + 32)
#define ITEM_MEMORY_SHARD_C3         (LAST_ITEM_OFFICIAL_EXPANSION + 33)
#define ITEM_MEMORY_SHARD_C4         (LAST_ITEM_OFFICIAL_EXPANSION + 34)
#define ITEM_MEMORY_SHARD_C5         (LAST_ITEM_OFFICIAL_EXPANSION + 35)
#define ITEM_MEMORY_SHARD_C6         (LAST_ITEM_OFFICIAL_EXPANSION + 36)
#define ITEM_MEMORY_SHARD_C7         (LAST_ITEM_OFFICIAL_EXPANSION + 37)
#define ITEM_MEMORY_SHARD_C8         (LAST_ITEM_OFFICIAL_EXPANSION + 38)
#define ITEM_MEMORY_SHARD_C9         (LAST_ITEM_OFFICIAL_EXPANSION + 39)
#define ITEM_CURE_MEMORY             (LAST_ITEM_OFFICIAL_EXPANSION + 40)
// BGHS
#define ITEM_MEMORY_SHARD_B1         (LAST_ITEM_OFFICIAL_EXPANSION + 41)
#define ITEM_MEMORY_SHARD_B2         (LAST_ITEM_OFFICIAL_EXPANSION + 42)
#define ITEM_MEMORY_SHARD_B3         (LAST_ITEM_OFFICIAL_EXPANSION + 43)
#define ITEM_MEMORY_SHARD_B4         (LAST_ITEM_OFFICIAL_EXPANSION + 44)
#define ITEM_MEMORY_SHARD_B5         (LAST_ITEM_OFFICIAL_EXPANSION + 45)
#define ITEM_MEMORY_SHARD_B6         (LAST_ITEM_OFFICIAL_EXPANSION + 46)
#define ITEM_MEMORY_SHARD_B7         (LAST_ITEM_OFFICIAL_EXPANSION + 47)
#define ITEM_MEMORY_SHARD_B8         (LAST_ITEM_OFFICIAL_EXPANSION + 48)
#define ITEM_MEMORY_SHARD_B9         (LAST_ITEM_OFFICIAL_EXPANSION + 49)
#define ITEM_BATTLE_MEMORY           (LAST_ITEM_OFFICIAL_EXPANSION + 50)
// Moemon
#define ITEM_MEMORY_SHARD_M1         (LAST_ITEM_OFFICIAL_EXPANSION + 51)
#define ITEM_MEMORY_SHARD_M2         (LAST_ITEM_OFFICIAL_EXPANSION + 52)
#define ITEM_MEMORY_SHARD_M3         (LAST_ITEM_OFFICIAL_EXPANSION + 53)
#define ITEM_MEMORY_SHARD_M4         (LAST_ITEM_OFFICIAL_EXPANSION + 54)
#define ITEM_MEMORY_SHARD_M5         (LAST_ITEM_OFFICIAL_EXPANSION + 55)
#define ITEM_MEMORY_SHARD_M6         (LAST_ITEM_OFFICIAL_EXPANSION + 56)
#define ITEM_MEMORY_SHARD_M7         (LAST_ITEM_OFFICIAL_EXPANSION + 57)
#define ITEM_MEMORY_SHARD_M8         (LAST_ITEM_OFFICIAL_EXPANSION + 58)
#define ITEM_MEMORY_SHARD_M9         (LAST_ITEM_OFFICIAL_EXPANSION + 59)
#define ITEM_ANOTHER_MEMORY          (LAST_ITEM_OFFICIAL_EXPANSION + 60)
// Others
#define ITEM_MEMORY_SHARD_X1         (LAST_ITEM_OFFICIAL_EXPANSION + 61)
#define ITEM_MEMORY_SHARD_X2         (LAST_ITEM_OFFICIAL_EXPANSION + 62)
#define ITEM_MEMORY_SHARD_X3         (LAST_ITEM_OFFICIAL_EXPANSION + 63)
#define ITEM_MEMORY_SHARD_X4         (LAST_ITEM_OFFICIAL_EXPANSION + 64)
#define ITEM_MEMORY_SHARD_X5         (LAST_ITEM_OFFICIAL_EXPANSION + 65)
#define ITEM_MEMORY_SHARD_X6         (LAST_ITEM_OFFICIAL_EXPANSION + 66)
#define ITEM_MEMORY_SHARD_X7         (LAST_ITEM_OFFICIAL_EXPANSION + 67)
#define ITEM_MEMORY_SHARD_X8         (LAST_ITEM_OFFICIAL_EXPANSION + 68)
#define ITEM_MEMORY_SHARD_X9         (LAST_ITEM_OFFICIAL_EXPANSION + 69)
#define ITEM_EXTRA_MEMORY            (LAST_ITEM_OFFICIAL_EXPANSION + 70)
// Shard of dream
#define ITEM_SHARD_OF_DREAM          (LAST_ITEM_OFFICIAL_EXPANSION + 71)
// Biboo related
#define ITEM_TOPAZ                   (LAST_ITEM_OFFICIAL_EXPANSION + 72)
#define ITEM_AMETHYST                (LAST_ITEM_OFFICIAL_EXPANSION + 73)
#define ITEM_EMERALD                 (LAST_ITEM_OFFICIAL_EXPANSION + 74)
#define ITEM_DIAMOND                 (LAST_ITEM_OFFICIAL_EXPANSION + 75)
#define ITEM_PEARL_GEMSTONE          (LAST_ITEM_OFFICIAL_EXPANSION + 76)
#define ITEM_EMOTION_STONE           (LAST_ITEM_OFFICIAL_EXPANSION + 77)
// Anya related
#define ITEM_ANCIENT_KRIS            (LAST_ITEM_OFFICIAL_EXPANSION + 78)
#define ITEM_7_FLOWERS               (LAST_ITEM_OFFICIAL_EXPANSION + 79)

#define LAST_ITEM_UNNOFICIAL         ITEM_7_FLOWERS

#define ITEMS_COUNT (LAST_ITEM_UNNOFICIAL + 1)
