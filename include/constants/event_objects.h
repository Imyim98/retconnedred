...
// Added Custom
#define OBJ_EVENT_GFX_KRIS                       239
#define OBJ_EVENT_GFX_MIKU                       240
#define OBJ_EVENT_GFX_TRAINER_PEA                241
// End Added Custom
#define OBJ_EVENT_GFX_POKE_BALL                  242
#define OBJ_EVENT_GFX_OW_MON                     243
#define OBJ_EVENT_GFX_LIGHT_SPRITE               244
#define OBJ_EVENT_GFX_APRICORN_TREE              245

// FRLG objects
#define OBJ_EVENT_GFX_RED_NORMAL                 (OBJ_EVENT_GFX_APRICORN_TREE + 1)
#define OBJ_EVENT_GFX_RED_BIKE                   (OBJ_EVENT_GFX_APRICORN_TREE + 2)
#define OBJ_EVENT_GFX_RED_SURF                   (OBJ_EVENT_GFX_APRICORN_TREE + 3)
#define OBJ_EVENT_GFX_RED_FIELD_MOVE             (OBJ_EVENT_GFX_APRICORN_TREE + 4)
#define OBJ_EVENT_GFX_RED_FISH                   (OBJ_EVENT_GFX_APRICORN_TREE + 5)
#define OBJ_EVENT_GFX_RED_VS_SEEKER              (OBJ_EVENT_GFX_APRICORN_TREE + 6)
#define OBJ_EVENT_GFX_RED_VS_SEEKER_BIKE         (OBJ_EVENT_GFX_APRICORN_TREE + 7)
#define OBJ_EVENT_GFX_GREEN_NORMAL               (OBJ_EVENT_GFX_APRICORN_TREE + 8)
#define OBJ_EVENT_GFX_GREEN_BIKE                 (OBJ_EVENT_GFX_APRICORN_TREE + 9)
#define OBJ_EVENT_GFX_GREEN_SURF                 (OBJ_EVENT_GFX_APRICORN_TREE + 10)
#define OBJ_EVENT_GFX_GREEN_FIELD_MOVE           (OBJ_EVENT_GFX_APRICORN_TREE + 11)
#define OBJ_EVENT_GFX_GREEN_FISH                 (OBJ_EVENT_GFX_APRICORN_TREE + 12)
#define OBJ_EVENT_GFX_GREEN_VS_SEEKER            (OBJ_EVENT_GFX_APRICORN_TREE + 13)
#define OBJ_EVENT_GFX_GREEN_VS_SEEKER_BIKE       (OBJ_EVENT_GFX_APRICORN_TREE + 14)
#define OBJ_EVENT_GFX_BOY                        (OBJ_EVENT_GFX_APRICORN_TREE + 15)
#define OBJ_EVENT_GFX_BATTLE_GIRL                (OBJ_EVENT_GFX_APRICORN_TREE + 16)
#define OBJ_EVENT_GFX_MAN                        (OBJ_EVENT_GFX_APRICORN_TREE + 17)
#define OBJ_EVENT_GFX_ROCKER                     (OBJ_EVENT_GFX_APRICORN_TREE + 18)
#define OBJ_EVENT_GFX_BALDING_MAN                (OBJ_EVENT_GFX_APRICORN_TREE + 19)
#define OBJ_EVENT_GFX_OLD_MAN_1                  (OBJ_EVENT_GFX_APRICORN_TREE + 20)
#define OBJ_EVENT_GFX_OLD_MAN_2                  (OBJ_EVENT_GFX_APRICORN_TREE + 21)
#define OBJ_EVENT_GFX_OLD_MAN_LYING_DOWN         (OBJ_EVENT_GFX_APRICORN_TREE + 22)
#define OBJ_EVENT_GFX_TUBER_M_WATER              (OBJ_EVENT_GFX_APRICORN_TREE + 23)
#define OBJ_EVENT_GFX_TUBER_M_LAND               (OBJ_EVENT_GFX_APRICORN_TREE + 24)
#define OBJ_EVENT_GFX_COOLTRAINER_M              (OBJ_EVENT_GFX_APRICORN_TREE + 25)
#define OBJ_EVENT_GFX_COOLTRAINER_F              (OBJ_EVENT_GFX_APRICORN_TREE + 26)
#define OBJ_EVENT_GFX_SWIMMER_M_WATER            (OBJ_EVENT_GFX_APRICORN_TREE + 27)
#define OBJ_EVENT_GFX_SWIMMER_F_WATER            (OBJ_EVENT_GFX_APRICORN_TREE + 28)
#define OBJ_EVENT_GFX_SWIMMER_M_LAND             (OBJ_EVENT_GFX_APRICORN_TREE + 29)
#define OBJ_EVENT_GFX_SWIMMER_F_LAND             (OBJ_EVENT_GFX_APRICORN_TREE + 30)
#define OBJ_EVENT_GFX_WORKER_M                   (OBJ_EVENT_GFX_APRICORN_TREE + 31)
#define OBJ_EVENT_GFX_WORKER_F                   (OBJ_EVENT_GFX_APRICORN_TREE + 32)
#define OBJ_EVENT_GFX_ROCKET_M                   (OBJ_EVENT_GFX_APRICORN_TREE + 33)
#define OBJ_EVENT_GFX_ROCKET_F                   (OBJ_EVENT_GFX_APRICORN_TREE + 34)
#define OBJ_EVENT_GFX_GBA_KID                    (OBJ_EVENT_GFX_APRICORN_TREE + 35)
#define OBJ_EVENT_GFX_SUPER_NERD                 (OBJ_EVENT_GFX_APRICORN_TREE + 36)
#define OBJ_EVENT_GFX_BIKER                      (OBJ_EVENT_GFX_APRICORN_TREE + 37)
#define OBJ_EVENT_GFX_BLACKBELT                  (OBJ_EVENT_GFX_APRICORN_TREE + 38)
#define OBJ_EVENT_GFX_SCIENTIST                  (OBJ_EVENT_GFX_APRICORN_TREE + 39)
#define OBJ_EVENT_GFX_FISHER                     (OBJ_EVENT_GFX_APRICORN_TREE + 40)
#define OBJ_EVENT_GFX_CHANNELER                  (OBJ_EVENT_GFX_APRICORN_TREE + 41)
#define OBJ_EVENT_GFX_CHEF                       (OBJ_EVENT_GFX_APRICORN_TREE + 42)
#define OBJ_EVENT_GFX_POLICEMAN                  (OBJ_EVENT_GFX_APRICORN_TREE + 43)
#define OBJ_EVENT_GFX_CAPTAIN                    (OBJ_EVENT_GFX_APRICORN_TREE + 44)
#define OBJ_EVENT_GFX_CABLE_CLUB_RECEPTIONIST    (OBJ_EVENT_GFX_APRICORN_TREE + 45)
#define OBJ_EVENT_GFX_UNION_ROOM_RECEPTIONIST    (OBJ_EVENT_GFX_APRICORN_TREE + 46)
#define OBJ_EVENT_GFX_CLERK                      (OBJ_EVENT_GFX_APRICORN_TREE + 47)
#define OBJ_EVENT_GFX_MG_DELIVERYMAN             (OBJ_EVENT_GFX_APRICORN_TREE + 48)
#define OBJ_EVENT_GFX_TRAINER_TOWER_DUDE         (OBJ_EVENT_GFX_APRICORN_TREE + 49)
#define OBJ_EVENT_GFX_PROF_OAK                   (OBJ_EVENT_GFX_APRICORN_TREE + 50)
#define OBJ_EVENT_GFX_BLUE                       (OBJ_EVENT_GFX_APRICORN_TREE + 51)
#define OBJ_EVENT_GFX_BILL                       (OBJ_EVENT_GFX_APRICORN_TREE + 52)
#define OBJ_EVENT_GFX_LANCE                      (OBJ_EVENT_GFX_APRICORN_TREE + 53)
#define OBJ_EVENT_GFX_AGATHA                     (OBJ_EVENT_GFX_APRICORN_TREE + 54)
#define OBJ_EVENT_GFX_DAISY                      (OBJ_EVENT_GFX_APRICORN_TREE + 55)
#define OBJ_EVENT_GFX_LORELEI                    (OBJ_EVENT_GFX_APRICORN_TREE + 56)
#define OBJ_EVENT_GFX_MR_FUJI                    (OBJ_EVENT_GFX_APRICORN_TREE + 57)
#define OBJ_EVENT_GFX_BRUNO                      (OBJ_EVENT_GFX_APRICORN_TREE + 58)
#define OBJ_EVENT_GFX_BROCK                      (OBJ_EVENT_GFX_APRICORN_TREE + 59)
#define OBJ_EVENT_GFX_MISTY                      (OBJ_EVENT_GFX_APRICORN_TREE + 60)
#define OBJ_EVENT_GFX_LT_SURGE                   (OBJ_EVENT_GFX_APRICORN_TREE + 61)
#define OBJ_EVENT_GFX_ERIKA                      (OBJ_EVENT_GFX_APRICORN_TREE + 62)
#define OBJ_EVENT_GFX_KOGA                       (OBJ_EVENT_GFX_APRICORN_TREE + 63)
#define OBJ_EVENT_GFX_SABRINA                    (OBJ_EVENT_GFX_APRICORN_TREE + 64)
#define OBJ_EVENT_GFX_BLAINE                     (OBJ_EVENT_GFX_APRICORN_TREE + 65)
#define OBJ_EVENT_GFX_GIOVANNI                   (OBJ_EVENT_GFX_APRICORN_TREE + 66)
#define OBJ_EVENT_GFX_CELIO                      (OBJ_EVENT_GFX_APRICORN_TREE + 67)
#define OBJ_EVENT_GFX_TEACHY_TV_HOST             (OBJ_EVENT_GFX_APRICORN_TREE + 68)
#define OBJ_EVENT_GFX_GYM_GUY                    (OBJ_EVENT_GFX_APRICORN_TREE + 69)
#define OBJ_EVENT_GFX_TOWN_MAP                   (OBJ_EVENT_GFX_APRICORN_TREE + 70)
#define OBJ_EVENT_GFX_POKEDEX                    (OBJ_EVENT_GFX_APRICORN_TREE + 71)
#define OBJ_EVENT_GFX_LITTLE_BOY_FRLG            (OBJ_EVENT_GFX_APRICORN_TREE + 72)
#define OBJ_EVENT_GFX_LITTLE_GIRL_FRLG           (OBJ_EVENT_GFX_APRICORN_TREE + 73)
#define OBJ_EVENT_GFX_YOUNGSTER_FRLG             (OBJ_EVENT_GFX_APRICORN_TREE + 74)
#define OBJ_EVENT_GFX_BUG_CATCHER_FRLG           (OBJ_EVENT_GFX_APRICORN_TREE + 75)
#define OBJ_EVENT_GFX_LASS_FRLG                  (OBJ_EVENT_GFX_APRICORN_TREE + 76)
#define OBJ_EVENT_GFX_WOMAN_1_FRLG               (OBJ_EVENT_GFX_APRICORN_TREE + 77)
#define OBJ_EVENT_GFX_FAT_MAN_FRLG               (OBJ_EVENT_GFX_APRICORN_TREE + 78)
#define OBJ_EVENT_GFX_WOMAN_2_FRLG               (OBJ_EVENT_GFX_APRICORN_TREE + 79)
#define OBJ_EVENT_GFX_BEAUTY_FRLG                (OBJ_EVENT_GFX_APRICORN_TREE + 80)
#define OBJ_EVENT_GFX_WOMAN_3_FRLG               (OBJ_EVENT_GFX_APRICORN_TREE + 81)
#define OBJ_EVENT_GFX_OLD_WOMAN_FRLG             (OBJ_EVENT_GFX_APRICORN_TREE + 82)
#define OBJ_EVENT_GFX_CAMPER_FRLG                (OBJ_EVENT_GFX_APRICORN_TREE + 83)
#define OBJ_EVENT_GFX_PICNICKER_FRLG             (OBJ_EVENT_GFX_APRICORN_TREE + 84)
#define OBJ_EVENT_GFX_MOM_FRLG                   (OBJ_EVENT_GFX_APRICORN_TREE + 85)
#define OBJ_EVENT_GFX_TUBER_F_FRLG               (OBJ_EVENT_GFX_APRICORN_TREE + 86)
#define OBJ_EVENT_GFX_HIKER_FRLG                 (OBJ_EVENT_GFX_APRICORN_TREE + 87)
#define OBJ_EVENT_GFX_GENTLEMAN_FRLG             (OBJ_EVENT_GFX_APRICORN_TREE + 88)
#define OBJ_EVENT_GFX_SAILOR_FRLG                (OBJ_EVENT_GFX_APRICORN_TREE + 89)
#define OBJ_EVENT_GFX_NURSE_FRLG                 (OBJ_EVENT_GFX_APRICORN_TREE + 90)
#define OBJ_EVENT_GFX_FOSSIL_FRLG                (OBJ_EVENT_GFX_APRICORN_TREE + 91)
#define OBJ_EVENT_GFX_RUBY                       (OBJ_EVENT_GFX_APRICORN_TREE + 92)
#define OBJ_EVENT_GFX_SAPPHIRE                   (OBJ_EVENT_GFX_APRICORN_TREE + 93)
#define OBJ_EVENT_GFX_OLD_AMBER                  (OBJ_EVENT_GFX_APRICORN_TREE + 94)
#define OBJ_EVENT_GFX_GYM_SIGN                   (OBJ_EVENT_GFX_APRICORN_TREE + 95)
#define OBJ_EVENT_GFX_SIGN                       (OBJ_EVENT_GFX_APRICORN_TREE + 96)
#define OBJ_EVENT_GFX_TRAINER_TIPS               (OBJ_EVENT_GFX_APRICORN_TREE + 97)
#define OBJ_EVENT_GFX_CLIPBOARD                  (OBJ_EVENT_GFX_APRICORN_TREE + 98)
#define OBJ_EVENT_GFX_METEORITE                  (OBJ_EVENT_GFX_APRICORN_TREE + 99)
#define OBJ_EVENT_GFX_LAPRAS_DOLL                (OBJ_EVENT_GFX_APRICORN_TREE + 100)
#define OBJ_EVENT_GFX_SEAGALLOP                  (OBJ_EVENT_GFX_APRICORN_TREE + 101)
#define OBJ_EVENT_GFX_SNORLAX                    (OBJ_EVENT_GFX_APRICORN_TREE + 102)
#define OBJ_EVENT_GFX_SPEAROW                    (OBJ_EVENT_GFX_APRICORN_TREE + 103)
#define OBJ_EVENT_GFX_CUBONE                     (OBJ_EVENT_GFX_APRICORN_TREE + 104)
#define OBJ_EVENT_GFX_POLIWRATH                  (OBJ_EVENT_GFX_APRICORN_TREE + 105)
#define OBJ_EVENT_GFX_CLEFAIRY                   (OBJ_EVENT_GFX_APRICORN_TREE + 106)
#define OBJ_EVENT_GFX_PIDGEOT                    (OBJ_EVENT_GFX_APRICORN_TREE + 107)
#define OBJ_EVENT_GFX_JIGGLYPUFF                 (OBJ_EVENT_GFX_APRICORN_TREE + 108)
#define OBJ_EVENT_GFX_PIDGEY                     (OBJ_EVENT_GFX_APRICORN_TREE + 109)
#define OBJ_EVENT_GFX_CHANSEY                    (OBJ_EVENT_GFX_APRICORN_TREE + 110)
#define OBJ_EVENT_GFX_OMANYTE                    (OBJ_EVENT_GFX_APRICORN_TREE + 111)
#define OBJ_EVENT_GFX_KANGASKHAN                 (OBJ_EVENT_GFX_APRICORN_TREE + 112)
#define OBJ_EVENT_GFX_PIKACHU_FRLG               (OBJ_EVENT_GFX_APRICORN_TREE + 113)
#define OBJ_EVENT_GFX_PSYDUCK                    (OBJ_EVENT_GFX_APRICORN_TREE + 114)
#define OBJ_EVENT_GFX_NIDORAN_F                  (OBJ_EVENT_GFX_APRICORN_TREE + 115)
#define OBJ_EVENT_GFX_NIDORAN_M                  (OBJ_EVENT_GFX_APRICORN_TREE + 116)
#define OBJ_EVENT_GFX_NIDORINO                   (OBJ_EVENT_GFX_APRICORN_TREE + 117)
#define OBJ_EVENT_GFX_MEOWTH                     (OBJ_EVENT_GFX_APRICORN_TREE + 118)
#define OBJ_EVENT_GFX_SEEL                       (OBJ_EVENT_GFX_APRICORN_TREE + 119)
#define OBJ_EVENT_GFX_VOLTORB                    (OBJ_EVENT_GFX_APRICORN_TREE + 120)
#define OBJ_EVENT_GFX_SLOWPOKE                   (OBJ_EVENT_GFX_APRICORN_TREE + 121)
#define OBJ_EVENT_GFX_SLOWBRO                    (OBJ_EVENT_GFX_APRICORN_TREE + 122)
#define OBJ_EVENT_GFX_MACHOP                     (OBJ_EVENT_GFX_APRICORN_TREE + 123)
#define OBJ_EVENT_GFX_WIGGLYTUFF                 (OBJ_EVENT_GFX_APRICORN_TREE + 124)
#define OBJ_EVENT_GFX_DODUO                      (OBJ_EVENT_GFX_APRICORN_TREE + 125)
#define OBJ_EVENT_GFX_FEAROW                     (OBJ_EVENT_GFX_APRICORN_TREE + 126)
#define OBJ_EVENT_GFX_MACHOKE                    (OBJ_EVENT_GFX_APRICORN_TREE + 127)
#define OBJ_EVENT_GFX_LAPRAS                     (OBJ_EVENT_GFX_APRICORN_TREE + 128)
#define OBJ_EVENT_GFX_ZAPDOS                     (OBJ_EVENT_GFX_APRICORN_TREE + 129)
#define OBJ_EVENT_GFX_MOLTRES                    (OBJ_EVENT_GFX_APRICORN_TREE + 130)
#define OBJ_EVENT_GFX_ARTICUNO                   (OBJ_EVENT_GFX_APRICORN_TREE + 131)
#define OBJ_EVENT_GFX_MEWTWO                     (OBJ_EVENT_GFX_APRICORN_TREE + 132)
#define OBJ_EVENT_GFX_ENTEI                      (OBJ_EVENT_GFX_APRICORN_TREE + 133)
#define OBJ_EVENT_GFX_SUICUNE                    (OBJ_EVENT_GFX_APRICORN_TREE + 134)
#define OBJ_EVENT_GFX_RAIKOU                     (OBJ_EVENT_GFX_APRICORN_TREE + 135)
#define OBJ_EVENT_GFX_CELEBI                     (OBJ_EVENT_GFX_APRICORN_TREE + 136)
#define OBJ_EVENT_GFX_KABUTO                     (OBJ_EVENT_GFX_APRICORN_TREE + 137)
#define OBJ_EVENT_GFX_DEOXYS_D                   (OBJ_EVENT_GFX_APRICORN_TREE + 138)
#define OBJ_EVENT_GFX_DEOXYS_A                   (OBJ_EVENT_GFX_APRICORN_TREE + 139)
#define OBJ_EVENT_GFX_DEOXYS_N                   (OBJ_EVENT_GFX_APRICORN_TREE + 140)
#define OBJ_EVENT_GFX_SS_ANNE                    (OBJ_EVENT_GFX_APRICORN_TREE + 141)
#define OBJ_EVENT_GFX_PUSHABLE_BOULDER_FRLG      (OBJ_EVENT_GFX_APRICORN_TREE + 142)
#define OBJ_EVENT_GFX_CUTTABLE_TREE_FRLG         (OBJ_EVENT_GFX_APRICORN_TREE + 143)
#define OBJ_EVENT_GFX_BREAKABLE_ROCK_FRLG        (OBJ_EVENT_GFX_APRICORN_TREE + 144)
...
#define NUM_OBJ_EVENT_GFX                        (OBJ_EVENT_GFX_BREAKABLE_ROCK_FRLG + 1)
