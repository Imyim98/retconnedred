...
#define MOVE_CLASSIC_DOUBLE_SLAP    (MOVE_ADDED_MODERN_END + 3)
#define MOVE_CLASSIC_COMET_PUNCH    (MOVE_ADDED_MODERN_END + 4)
#define MOVE_CLASSIC_MEGA_PUNCH     (MOVE_ADDED_MODERN_END + 5)
#define MOVE_CLASSIC_PAY_DAY        (MOVE_ADDED_MODERN_END + 6)
#define MOVE_CLASSIC_FIRE_PUNCH     (MOVE_ADDED_MODERN_END + 7)
#define MOVE_CLASSIC_ICE_PUNCH      (MOVE_ADDED_MODERN_END + 8)
#define MOVE_CLASSIC_THUNDER_PUNCH  (MOVE_ADDED_MODERN_END + 9)
#define MOVE_CLASSIC_SCRATCH        (MOVE_ADDED_MODERN_END + 10)
#define MOVE_CLASSIC_VISE_GRIP      (MOVE_ADDED_MODERN_END + 11)
#define MOVE_CLASSIC_VICE_GRIP      MOVE_CLASSIC_VISE_GRIP
#define MOVE_CLASSIC_VICEGRIP       MOVE_CLASSIC_VISE_GRIP
#define MOVE_CLASSIC_GUILLOTINE     (MOVE_ADDED_MODERN_END + 12)
#define MOVE_CLASSIC_RAZOR_WIND     (MOVE_ADDED_MODERN_END + 13)
#define MOVE_CLASSIC_SWORDS_DANCE   (MOVE_ADDED_MODERN_END + 14)
#define MOVE_CLASSIC_CUT            (MOVE_ADDED_MODERN_END + 15)
#define MOVE_CLASSIC_GUST           (MOVE_ADDED_MODERN_END + 16)
#define MOVE_CLASSIC_WING_ATTACK    (MOVE_ADDED_MODERN_END + 17)
#define MOVE_CLASSIC_WHIRLWIND      (MOVE_ADDED_MODERN_END + 18)
#define MOVE_CLASSIC_FLY            (MOVE_ADDED_MODERN_END + 19)
#define MOVE_CLASSIC_BIND           (MOVE_ADDED_MODERN_END + 20)
#define MOVE_CLASSIC_SLAM           (MOVE_ADDED_MODERN_END + 21)
#define MOVE_CLASSIC_VINE_WHIP      (MOVE_ADDED_MODERN_END + 22)
#define MOVE_CLASSIC_STOMP          (MOVE_ADDED_MODERN_END + 23)
#define MOVE_CLASSIC_DOUBLE_KICK    (MOVE_ADDED_MODERN_END + 24)
#define MOVE_CLASSIC_MEGA_KICK      (MOVE_ADDED_MODERN_END + 25)
#define MOVE_CLASSIC_JUMP_KICK      (MOVE_ADDED_MODERN_END + 26)
#define MOVE_CLASSIC_ROLLING_KICK   (MOVE_ADDED_MODERN_END + 27)
#define MOVE_CLASSIC_SAND_ATTACK    (MOVE_ADDED_MODERN_END + 28)
#define MOVE_CLASSIC_HEADBUTT       (MOVE_ADDED_MODERN_END + 29)
#define MOVE_CLASSIC_HORN_ATTACK    (MOVE_ADDED_MODERN_END + 30)
#define MOVE_CLASSIC_FURY_ATTACK    (MOVE_ADDED_MODERN_END + 31)
#define MOVE_CLASSIC_HORN_DRILL     (MOVE_ADDED_MODERN_END + 32)
#define MOVE_CLASSIC_TACKLE         (MOVE_ADDED_MODERN_END + 33)
#define MOVE_CLASSIC_BODY_SLAM      (MOVE_ADDED_MODERN_END + 34)
#define MOVE_CLASSIC_WRAP           (MOVE_ADDED_MODERN_END + 35)
#define MOVE_CLASSIC_TAKE_DOWN      (MOVE_ADDED_MODERN_END + 36)
#define MOVE_CLASSIC_THRASH         (MOVE_ADDED_MODERN_END + 37)
#define MOVE_CLASSIC_DOUBLE_EDGE    (MOVE_ADDED_MODERN_END + 38)
#define MOVE_CLASSIC_TAIL_WHIP      (MOVE_ADDED_MODERN_END + 39)
#define MOVE_CLASSIC_POISON_STING   (MOVE_ADDED_MODERN_END + 40)
#define MOVE_CLASSIC_TWINEEDLE      (MOVE_ADDED_MODERN_END + 41)
#define MOVE_CLASSIC_PIN_MISSILE    (MOVE_ADDED_MODERN_END + 42)
#define MOVE_CLASSIC_LEER           (MOVE_ADDED_MODERN_END + 43)
#define MOVE_CLASSIC_BITE           (MOVE_ADDED_MODERN_END + 44)
#define MOVE_CLASSIC_GROWL          (MOVE_ADDED_MODERN_END + 45)
#define MOVE_CLASSIC_ROAR           (MOVE_ADDED_MODERN_END + 46)
#define MOVE_CLASSIC_SING           (MOVE_ADDED_MODERN_END + 47)
#define MOVE_CLASSIC_SUPERSONIC     (MOVE_ADDED_MODERN_END + 48)
#define MOVE_CLASSIC_SONIC_BOOM     (MOVE_ADDED_MODERN_END + 49)
#define MOVE_CLASSIC_DISABLE        (MOVE_ADDED_MODERN_END + 50)
#define MOVE_CLASSIC_ACID           (MOVE_ADDED_MODERN_END + 51)
#define MOVE_CLASSIC_EMBER          (MOVE_ADDED_MODERN_END + 52)
#define MOVE_CLASSIC_FLAMETHROWER   (MOVE_ADDED_MODERN_END + 53)
#define MOVE_CLASSIC_MIST           (MOVE_ADDED_MODERN_END + 54)
#define MOVE_CLASSIC_WATER_GUN      (MOVE_ADDED_MODERN_END + 55)
#define MOVE_CLASSIC_HYDRO_PUMP     (MOVE_ADDED_MODERN_END + 56)
#define MOVE_CLASSIC_SURF           (MOVE_ADDED_MODERN_END + 57)
#define MOVE_CLASSIC_ICE_BEAM       (MOVE_ADDED_MODERN_END + 58)
#define MOVE_CLASSIC_BLIZZARD       (MOVE_ADDED_MODERN_END + 59)
#define MOVE_CLASSIC_PSYBEAM        (MOVE_ADDED_MODERN_END + 60)
#define MOVE_CLASSIC_BUBBLE_BEAM    (MOVE_ADDED_MODERN_END + 61)
#define MOVE_CLASSIC_AURORA_BEAM    (MOVE_ADDED_MODERN_END + 62)
#define MOVE_CLASSIC_HYPER_BEAM     (MOVE_ADDED_MODERN_END + 63)
#define MOVE_CLASSIC_PECK           (MOVE_ADDED_MODERN_END + 64)
#define MOVE_CLASSIC_DRILL_PECK     (MOVE_ADDED_MODERN_END + 65)
#define MOVE_CLASSIC_SUBMISSION     (MOVE_ADDED_MODERN_END + 66)
#define MOVE_CLASSIC_LOW_KICK       (MOVE_ADDED_MODERN_END + 67)
#define MOVE_CLASSIC_COUNTER        (MOVE_ADDED_MODERN_END + 68)
#define MOVE_CLASSIC_SEISMIC_TOSS   (MOVE_ADDED_MODERN_END + 69)
#define MOVE_CLASSIC_STRENGTH       (MOVE_ADDED_MODERN_END + 70)
#define MOVE_CLASSIC_ABSORB         (MOVE_ADDED_MODERN_END + 71)
#define MOVE_CLASSIC_MEGA_DRAIN     (MOVE_ADDED_MODERN_END + 72)
#define MOVE_CLASSIC_LEECH_SEED     (MOVE_ADDED_MODERN_END + 73)
#define MOVE_CLASSIC_GROWTH         (MOVE_ADDED_MODERN_END + 74)
#define MOVE_CLASSIC_RAZOR_LEAF     (MOVE_ADDED_MODERN_END + 75)
#define MOVE_CLASSIC_SOLAR_BEAM     (MOVE_ADDED_MODERN_END + 76)
#define MOVE_CLASSIC_SOLARBEAM      MOVE_CLASSIC_SOLAR_BEAM
#define MOVE_CLASSIC_POISON_POWDER  (MOVE_ADDED_MODERN_END + 77)
#define MOVE_CLASSIC_STUN_SPORE     (MOVE_ADDED_MODERN_END + 78)
#define MOVE_CLASSIC_SLEEP_POWDER   (MOVE_ADDED_MODERN_END + 79)
#define MOVE_CLASSIC_PETAL_DANCE    (MOVE_ADDED_MODERN_END + 80)
#define MOVE_CLASSIC_STRING_SHOT    (MOVE_ADDED_MODERN_END + 81)
#define MOVE_CLASSIC_DRAGON_RAGE    (MOVE_ADDED_MODERN_END + 82)
#define MOVE_CLASSIC_FIRE_SPIN      (MOVE_ADDED_MODERN_END + 83)
#define MOVE_CLASSIC_THUNDER_SHOCK  (MOVE_ADDED_MODERN_END + 84)
#define MOVE_CLASSIC_THUNDERBOLT    (MOVE_ADDED_MODERN_END + 85)
#define MOVE_CLASSIC_THUNDER_WAVE   (MOVE_ADDED_MODERN_END + 86)
#define MOVE_CLASSIC_THUNDER        (MOVE_ADDED_MODERN_END + 87)
#define MOVE_CLASSIC_ROCK_THROW     (MOVE_ADDED_MODERN_END + 88)
#define MOVE_CLASSIC_EARTHQUAKE     (MOVE_ADDED_MODERN_END + 89)
#define MOVE_CLASSIC_FISSURE        (MOVE_ADDED_MODERN_END + 90)
#define MOVE_CLASSIC_DIG            (MOVE_ADDED_MODERN_END + 91)
#define MOVE_CLASSIC_TOXIC          (MOVE_ADDED_MODERN_END + 92)
#define MOVE_CLASSIC_CONFUSION      (MOVE_ADDED_MODERN_END + 93)
#define MOVE_CLASSIC_PSYCHIC        (MOVE_ADDED_MODERN_END + 94)
#define MOVE_CLASSIC_HYPNOSIS       (MOVE_ADDED_MODERN_END + 95)
#define MOVE_CLASSIC_MEDITATE       (MOVE_ADDED_MODERN_END + 96)
#define MOVE_CLASSIC_AGILITY        (MOVE_ADDED_MODERN_END + 97)
#define MOVE_CLASSIC_QUICK_ATTACK   (MOVE_ADDED_MODERN_END + 98)
#define MOVE_CLASSIC_RAGE           (MOVE_ADDED_MODERN_END + 99)
#define MOVE_CLASSIC_TELEPORT       (MOVE_ADDED_MODERN_END + 100)
#define MOVE_CLASSIC_NIGHT_SHADE    (MOVE_ADDED_MODERN_END + 101)
#define MOVE_CLASSIC_MIMIC          (MOVE_ADDED_MODERN_END + 102)
#define MOVE_CLASSIC_SCREECH        (MOVE_ADDED_MODERN_END + 103)
#define MOVE_CLASSIC_DOUBLE_TEAM    (MOVE_ADDED_MODERN_END + 104)
#define MOVE_CLASSIC_RECOVER        (MOVE_ADDED_MODERN_END + 105)
#define MOVE_CLASSIC_HARDEN         (MOVE_ADDED_MODERN_END + 106)
#define MOVE_CLASSIC_MINIMIZE       (MOVE_ADDED_MODERN_END + 107)
#define MOVE_CLASSIC_SMOKESCREEN    (MOVE_ADDED_MODERN_END + 108)
#define MOVE_CLASSIC_CONFUSE_RAY    (MOVE_ADDED_MODERN_END + 109)
#define MOVE_CLASSIC_WITHDRAW       (MOVE_ADDED_MODERN_END + 110)
#define MOVE_CLASSIC_DEFENSE_CURL   (MOVE_ADDED_MODERN_END + 111)
#define MOVE_CLASSIC_BARRIER        (MOVE_ADDED_MODERN_END + 112)
#define MOVE_CLASSIC_LIGHT_SCREEN   (MOVE_ADDED_MODERN_END + 113)
#define MOVE_CLASSIC_HAZE           (MOVE_ADDED_MODERN_END + 114)
#define MOVE_CLASSIC_REFLECT        (MOVE_ADDED_MODERN_END + 115)
#define MOVE_CLASSIC_FOCUS_ENERGY   (MOVE_ADDED_MODERN_END + 116)
#define MOVE_CLASSIC_BIDE           (MOVE_ADDED_MODERN_END + 117)
#define MOVE_CLASSIC_METRONOME      (MOVE_ADDED_MODERN_END + 118)
#define MOVE_CLASSIC_MIRROR_MOVE    (MOVE_ADDED_MODERN_END + 119)
#define MOVE_CLASSIC_SELF_DESTRUCT  (MOVE_ADDED_MODERN_END + 120)
#define MOVE_CLASSIC_EGG_BOMB       (MOVE_ADDED_MODERN_END + 121)
#define MOVE_CLASSIC_LICK           (MOVE_ADDED_MODERN_END + 122)
#define MOVE_CLASSIC_SMOG           (MOVE_ADDED_MODERN_END + 123)
#define MOVE_CLASSIC_SLUDGE         (MOVE_ADDED_MODERN_END + 124)
#define MOVE_CLASSIC_BONE_CLUB      (MOVE_ADDED_MODERN_END + 125)
#define MOVE_CLASSIC_FIRE_BLAST     (MOVE_ADDED_MODERN_END + 126)
#define MOVE_CLASSIC_WATERFALL      (MOVE_ADDED_MODERN_END + 127)
#define MOVE_CLASSIC_CLAMP          (MOVE_ADDED_MODERN_END + 128)
#define MOVE_CLASSIC_SWIFT          (MOVE_ADDED_MODERN_END + 129)
#define MOVE_CLASSIC_SKULL_BASH     (MOVE_ADDED_MODERN_END + 130)
#define MOVE_CLASSIC_SPIKE_CANNON   (MOVE_ADDED_MODERN_END + 131)
#define MOVE_CLASSIC_CONSTRICT      (MOVE_ADDED_MODERN_END + 132)
#define MOVE_CLASSIC_AMNESIA        (MOVE_ADDED_MODERN_END + 133)
#define MOVE_CLASSIC_KINESIS        (MOVE_ADDED_MODERN_END + 134)
#define MOVE_CLASSIC_SOFT_BOILED    (MOVE_ADDED_MODERN_END + 135)
#define MOVE_CLASSIC_HIGH_JUMP_KICK (MOVE_ADDED_MODERN_END + 136)
#define MOVE_CLASSIC_HI_JUMP_KICK   MOVE_CLASSIC_HIGH_JUMP_KICK
#define MOVE_CLASSIC_GLARE          (MOVE_ADDED_MODERN_END + 137)
#define MOVE_CLASSIC_DREAM_EATER    (MOVE_ADDED_MODERN_END + 138)
#define MOVE_CLASSIC_POISON_GAS     (MOVE_ADDED_MODERN_END + 139)
#define MOVE_CLASSIC_BARRAGE        (MOVE_ADDED_MODERN_END + 140)
#define MOVE_CLASSIC_LEECH_LIFE     (MOVE_ADDED_MODERN_END + 141)
#define MOVE_CLASSIC_LOVELY_KISS    (MOVE_ADDED_MODERN_END + 142)
#define MOVE_CLASSIC_SKY_ATTACK     (MOVE_ADDED_MODERN_END + 143)
#define MOVE_CLASSIC_TRANSFORM      (MOVE_ADDED_MODERN_END + 144)
#define MOVE_CLASSIC_BUBBLE         (MOVE_ADDED_MODERN_END + 145)
#define MOVE_CLASSIC_DIZZY_PUNCH    (MOVE_ADDED_MODERN_END + 146)
#define MOVE_CLASSIC_SPORE          (MOVE_ADDED_MODERN_END + 147)
#define MOVE_CLASSIC_FLASH          (MOVE_ADDED_MODERN_END + 148)
#define MOVE_CLASSIC_PSYWAVE        (MOVE_ADDED_MODERN_END + 149)
#define MOVE_CLASSIC_SPLASH         (MOVE_ADDED_MODERN_END + 150)
#define MOVE_CLASSIC_ACID_ARMOR     (MOVE_ADDED_MODERN_END + 151)
#define MOVE_CLASSIC_CRABHAMMER     (MOVE_ADDED_MODERN_END + 152)
#define MOVE_CLASSIC_EXPLOSION      (MOVE_ADDED_MODERN_END + 153)
#define MOVE_CLASSIC_FURY_SWIPES    (MOVE_ADDED_MODERN_END + 154)
#define MOVE_CLASSIC_BONEMERANG     (MOVE_ADDED_MODERN_END + 155)
#define MOVE_CLASSIC_REST           (MOVE_ADDED_MODERN_END + 156)
#define MOVE_CLASSIC_ROCK_SLIDE     (MOVE_ADDED_MODERN_END + 157)
#define MOVE_CLASSIC_HYPER_FANG     (MOVE_ADDED_MODERN_END + 158)
#define MOVE_CLASSIC_SHARPEN        (MOVE_ADDED_MODERN_END + 159)
#define MOVE_CLASSIC_CONVERSION     (MOVE_ADDED_MODERN_END + 160)
#define MOVE_CLASSIC_TRI_ATTACK     (MOVE_ADDED_MODERN_END + 161)
#define MOVE_CLASSIC_SUPER_FANG     (MOVE_ADDED_MODERN_END + 162)
#define MOVE_CLASSIC_SLASH          (MOVE_ADDED_MODERN_END + 163)
#define MOVE_CLASSIC_SUBSTITUTE     (MOVE_ADDED_MODERN_END + 164)
#define MOVE_CLASSIC_STRUGGLE       (MOVE_ADDED_MODERN_END + 165)
#define MOVE_CLASSIC_SKETCH         (MOVE_ADDED_MODERN_END + 166)
#define MOVE_CLASSIC_TRIPLE_KICK    (MOVE_ADDED_MODERN_END + 167)
#define MOVE_CLASSIC_THIEF          (MOVE_ADDED_MODERN_END + 168)
#define MOVE_CLASSIC_SPIDER_WEB     (MOVE_ADDED_MODERN_END + 169)
#define MOVE_CLASSIC_MIND_READER    (MOVE_ADDED_MODERN_END + 170)
#define MOVE_CLASSIC_NIGHTMARE      (MOVE_ADDED_MODERN_END + 171)
#define MOVE_CLASSIC_FLAME_WHEEL    (MOVE_ADDED_MODERN_END + 172)
#define MOVE_CLASSIC_SNORE          (MOVE_ADDED_MODERN_END + 173)
#define MOVE_CLASSIC_CURSE          (MOVE_ADDED_MODERN_END + 174)
#define MOVE_CLASSIC_FLAIL          (MOVE_ADDED_MODERN_END + 175)
#define MOVE_CLASSIC_CONVERSION_2   (MOVE_ADDED_MODERN_END + 176)
#define MOVE_CLASSIC_AEROBLAST      (MOVE_ADDED_MODERN_END + 177)
#define MOVE_CLASSIC_COTTON_SPORE   (MOVE_ADDED_MODERN_END + 178)
#define MOVE_CLASSIC_REVERSAL       (MOVE_ADDED_MODERN_END + 179)
#define MOVE_CLASSIC_SPITE          (MOVE_ADDED_MODERN_END + 180)
#define MOVE_CLASSIC_POWDER_SNOW    (MOVE_ADDED_MODERN_END + 181)
#define MOVE_CLASSIC_PROTECT        (MOVE_ADDED_MODERN_END + 182)
#define MOVE_CLASSIC_MACH_PUNCH     (MOVE_ADDED_MODERN_END + 183)
#define MOVE_CLASSIC_SCARY_FACE     (MOVE_ADDED_MODERN_END + 184)
#define MOVE_CLASSIC_FEINT_ATTACK   (MOVE_ADDED_MODERN_END + 185)
#define MOVE_CLASSIC_FAINT_ATTACK   MOVE_CLASSIC_FEINT_ATTACK
#define MOVE_CLASSIC_SWEET_KISS     (MOVE_ADDED_MODERN_END + 186)
#define MOVE_CLASSIC_BELLY_DRUM     (MOVE_ADDED_MODERN_END + 187)
#define MOVE_CLASSIC_SLUDGE_BOMB    (MOVE_ADDED_MODERN_END + 188)
#define MOVE_CLASSIC_MUD_SLAP       (MOVE_ADDED_MODERN_END + 189)
#define MOVE_CLASSIC_OCTAZOOKA      (MOVE_ADDED_MODERN_END + 190)
#define MOVE_CLASSIC_SPIKES         (MOVE_ADDED_MODERN_END + 191)
#define MOVE_CLASSIC_ZAP_CANNON     (MOVE_ADDED_MODERN_END + 192)
#define MOVE_CLASSIC_FORESIGHT      (MOVE_ADDED_MODERN_END + 193)
#define MOVE_CLASSIC_DESTINY_BOND   (MOVE_ADDED_MODERN_END + 194)
#define MOVE_CLASSIC_PERISH_SONG    (MOVE_ADDED_MODERN_END + 195)
#define MOVE_CLASSIC_ICY_WIND       (MOVE_ADDED_MODERN_END + 196)
#define MOVE_CLASSIC_DETECT         (MOVE_ADDED_MODERN_END + 197)
#define MOVE_CLASSIC_BONE_RUSH      (MOVE_ADDED_MODERN_END + 198)
#define MOVE_CLASSIC_LOCK_ON        (MOVE_ADDED_MODERN_END + 199)
#define MOVE_CLASSIC_OUTRAGE        (MOVE_ADDED_MODERN_END + 200)
#define MOVE_CLASSIC_SANDSTORM      (MOVE_ADDED_MODERN_END + 201)
#define MOVE_CLASSIC_GIGA_DRAIN     (MOVE_ADDED_MODERN_END + 202)
#define MOVE_CLASSIC_ENDURE         (MOVE_ADDED_MODERN_END + 203)
#define MOVE_CLASSIC_CHARM          (MOVE_ADDED_MODERN_END + 204)
#define MOVE_CLASSIC_ROLLOUT        (MOVE_ADDED_MODERN_END + 205)
#define MOVE_CLASSIC_FALSE_SWIPE    (MOVE_ADDED_MODERN_END + 206)
#define MOVE_CLASSIC_SWAGGER        (MOVE_ADDED_MODERN_END + 207)
#define MOVE_CLASSIC_MILK_DRINK     (MOVE_ADDED_MODERN_END + 208)
#define MOVE_CLASSIC_SPARK          (MOVE_ADDED_MODERN_END + 209)
#define MOVE_CLASSIC_FURY_CUTTER    (MOVE_ADDED_MODERN_END + 210)
#define MOVE_CLASSIC_STEEL_WING     (MOVE_ADDED_MODERN_END + 211)
#define MOVE_CLASSIC_MEAN_LOOK      (MOVE_ADDED_MODERN_END + 212)
#define MOVE_CLASSIC_ATTRACT        (MOVE_ADDED_MODERN_END + 213)
#define MOVE_CLASSIC_SLEEP_TALK     (MOVE_ADDED_MODERN_END + 214)
#define MOVE_CLASSIC_HEAL_BELL      (MOVE_ADDED_MODERN_END + 215)
#define MOVE_CLASSIC_RETURN         (MOVE_ADDED_MODERN_END + 216)
#define MOVE_CLASSIC_PRESENT        (MOVE_ADDED_MODERN_END + 217)
#define MOVE_CLASSIC_FRUSTRATION    (MOVE_ADDED_MODERN_END + 218)
#define MOVE_CLASSIC_SAFEGUARD      (MOVE_ADDED_MODERN_END + 219)
#define MOVE_CLASSIC_PAIN_SPLIT     (MOVE_ADDED_MODERN_END + 220)
#define MOVE_CLASSIC_SACRED_FIRE    (MOVE_ADDED_MODERN_END + 221)
#define MOVE_CLASSIC_MAGNITUDE      (MOVE_ADDED_MODERN_END + 222)
#define MOVE_CLASSIC_DYNAMIC_PUNCH  (MOVE_ADDED_MODERN_END + 223)
#define MOVE_CLASSIC_MEGAHORN       (MOVE_ADDED_MODERN_END + 224)
#define MOVE_CLASSIC_DRAGON_BREATH  (MOVE_ADDED_MODERN_END + 225)
#define MOVE_CLASSIC_BATON_PASS     (MOVE_ADDED_MODERN_END + 226)
#define MOVE_CLASSIC_ENCORE         (MOVE_ADDED_MODERN_END + 227)
#define MOVE_CLASSIC_PURSUIT        (MOVE_ADDED_MODERN_END + 228)
#define MOVE_CLASSIC_RAPID_SPIN     (MOVE_ADDED_MODERN_END + 229)
#define MOVE_CLASSIC_SWEET_SCENT    (MOVE_ADDED_MODERN_END + 230)
#define MOVE_CLASSIC_IRON_TAIL      (MOVE_ADDED_MODERN_END + 231)
#define MOVE_CLASSIC_METAL_CLAW     (MOVE_ADDED_MODERN_END + 232)
#define MOVE_CLASSIC_VITAL_THROW    (MOVE_ADDED_MODERN_END + 233)
#define MOVE_CLASSIC_MORNING_SUN    (MOVE_ADDED_MODERN_END + 234)
#define MOVE_CLASSIC_SYNTHESIS      (MOVE_ADDED_MODERN_END + 235)
#define MOVE_CLASSIC_MOONLIGHT      (MOVE_ADDED_MODERN_END + 236)
#define MOVE_CLASSIC_HIDDEN_POWER   (MOVE_ADDED_MODERN_END + 237)
#define MOVE_CLASSIC_CROSS_CHOP     (MOVE_ADDED_MODERN_END + 238)
#define MOVE_CLASSIC_TWISTER        (MOVE_ADDED_MODERN_END + 239)
#define MOVE_CLASSIC_RAIN_DANCE     (MOVE_ADDED_MODERN_END + 240)
#define MOVE_CLASSIC_SUNNY_DAY      (MOVE_ADDED_MODERN_END + 241)
#define MOVE_CLASSIC_CRUNCH         (MOVE_ADDED_MODERN_END + 242)
#define MOVE_CLASSIC_MIRROR_COAT    (MOVE_ADDED_MODERN_END + 243)
#define MOVE_CLASSIC_PSYCH_UP       (MOVE_ADDED_MODERN_END + 244)
#define MOVE_CLASSIC_EXTREME_SPEED  (MOVE_ADDED_MODERN_END + 245)
#define MOVE_CLASSIC_ANCIENT_POWER  (MOVE_ADDED_MODERN_END + 246)
#define MOVE_CLASSIC_SHADOW_BALL    (MOVE_ADDED_MODERN_END + 247)
#define MOVE_CLASSIC_FUTURE_SIGHT   (MOVE_ADDED_MODERN_END + 248)
#define MOVE_CLASSIC_ROCK_SMASH     (MOVE_ADDED_MODERN_END + 249)
#define MOVE_CLASSIC_WHIRLPOOL      (MOVE_ADDED_MODERN_END + 250)
#define MOVE_CLASSIC_BEAT_UP        (MOVE_ADDED_MODERN_END + 251)

#define MOVE_END_CLASSIC            MOVE_CLASSIC_BEAT_UP
