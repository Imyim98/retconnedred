...
enum MoveEndState
{
    ...
    MOVEEND_QUEUE_GRAND_THEORY,
    MOVEEND_QUEUE_ECHO_ABILITIES_DOUR,
    MOVEEND_QUEUE_ECHO_ABILITIES_MANIC,
    MOVEEND_QUEUE_ECHO_ABILITIES_LAST_CADENZA,
    MOVEEND_QUEUE_PRIDE,
    MOVEEND_QUEUE_HEALING_SAINT,
    ...
    MOVEEND_CLEAR_BITS,
    MOVEEND_DANCER,
    MOVEEND_GRAND_THEORY,
    MOVEEND_ECHO_ABILITIES_DOUR,
    MOVEEND_ECHO_ABILITIES_MANIC,
    MOVEEND_ECHO_ABILITIES_LAST_CADENZA,
    MOVEEND_PRIDE,
    MOVEEND_HEALING_SAINT,
