...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_GRACE_OF_DREAM,              graceOfDream,                  (u32, 5), V_BATON_PASSABLE) \
...
enum TypeSideHazard
{
    TYPE_SIDE_HAZARD_POINTED_STONES = TYPE_NEW_BEAST,
    TYPE_SIDE_HAZARD_SHARP_STEEL    = TYPE_NEW_METAL,
};
...
#define B_WEATHER_EX_SHADOW_SKY_NORMAL   (1 << BATTLE_WEATHER_EX_SHADOW_SKY)
#define B_WEATHER_EX_SHADOW_SKY_DEEP     (1 << BATTLE_WEATHER_EX_SHADOW_SKY_DEEP)
#define B_WEATHER_EX_SHADOW_SKY          (B_WEATHER_EX_SHADOW_SKY_NORMAL | B_WEATHER_EX_SHADOW_SKY_DEEP)

#define B_WEATHER_DAMAGING_ANY  (B_WEATHER_HAIL | B_WEATHER_SANDSTORM | B_WEATHER_EX_SHADOW_SKY_NORMAL | B_WEATHER_EX_SHADOW_SKY)
#define B_WEATHER_ICY_ANY       (B_WEATHER_HAIL | B_WEATHER_SNOW)
#define B_WEATHER_LOW_LIGHT     (B_WEATHER_FOG | B_WEATHER_ICY_ANY | B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SANDSTORM | B_WEATHER_EX_SHADOW_SKY)
...
#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_ICY_ANY | B_WEATHER_STRONG_WINDS | B_WEATHER_FOG | B_WEATHER_EX_SHADOW_SKY)
...
#define STARTING_STATUS_DEFINITIONS(F) \
    ...
    /* Custom */                                                                                                                           \
    F(STARTING_STATUS_UBW,                            UBWTerrain,                 (u32, 1)) /* UBW Terrain (Permanent) */                  \
    F(STARTING_STATUS_UBW_TEMPORARY,                  UBWTerrainTemporary,        (u32, 1)) /* UBW Terrain Temporary (5 turns) */          \
    F(STARTING_STATUS_DARKNESS_TERRAIN,               darknessTerrain,            (u32, 1)) /* Darkness Terrain (Permanent) */             \
    F(STARTING_STATUS_DARKNESS_TERRAIN_TEMPORARY,     darknessTerrainTemporary,   (u32, 1)) /* Darkness Terrain Temporary (5 turns) */     \
    F(STARTING_STATUS_MIASMA_TERRAIN,                 miasmaTerrain,              (u32, 1)) /* Miasma Terrain (Permanent) */               \
    F(STARTING_STATUS_MIASMA_TERRAIN_TEMPORARY,       miasmaTerrainTemporary,     (u32, 1)) /* Miasma Terrain Temporary (5 turns) */       \
