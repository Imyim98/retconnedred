...
#define FRANCHISE_ORIGIN_POKEMON      BODY_COLOR_RED
#define FRANCHISE_ORIGIN_MOEMON       BODY_COLOR_BLUE
#define FRANCHISE_ORIGIN_YUYUYUI      BODY_COLOR_YELLOW
#define FRANCHISE_ORIGIN_TOUHOU       BODY_COLOR_GREEN
#define FRANCHISE_ORIGIN_SEIHOU       BODY_COLOR_BLACK
#define FRANCHISE_ORIGIN_KEY          BODY_COLOR_BROWN
#define FRANCHISE_ORIGIN_BGHS         BODY_COLOR_PURPLE
#define FRANCHISE_ORIGIN_PRECURE      BODY_COLOR_GRAY
#define FRANCHISE_ORIGIN_OTHER        BODY_COLOR_WHITE
#define FRANCHISE_ORIGIN_UNIDENTIFIED BODY_COLOR_PINK
