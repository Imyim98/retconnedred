...
enum StringID
{
    ...
    STRINGID_GOTCHAPKMNCAUGHTPLAYER_NO_MUSIC,
    ...
    // Custom added
    STRINGID_FANTASYBREAKERENTERS,
    STRINGID_YORIGAMICURSE,
    STRINGID_PKMNRAISEDEVASION,
    STRINGID_TIMEJACKERENTERS,
    STRINGID_LEECHSEEDHEALSABILITYPUREWHITE,
    STRINGID_PKMNFLUFFIEDINTO,
    STRINGID_PARTYGOTWIPEDOUT,
    STRINGID_PKMNCUTSSPATTACKWITH,
    STRINGID_PKMNISWISHING,
    STRINGID_SETUPDIMENSIONWALL,
    STRINGID_UNLIMITEDKRISWORKS,
    STRINGID_UBWFADED,
    STRINGID_SETUPHAKUREIBARRIER,
    STRINGID_CAUSESCHAOSONTHEOPPOSINGSIDE,
    STRINGID_TEAMTRAPPEDINTHEWORLDENDGARDEN,
    STRINGID_PKMNHURTBYWORLDENDGARDEN,
    STRINGID_WORLDENDGARDENPREVENTSCOURTCHANGE,
    STRINGID_PKMNCUTSACCWITH,
    STRINGID_FLORAELVISSAFEGUARD,
    STRINGID_PKMNRAISEDATTACK,
    STRINGID_DIVINETREEBLESSING,
    STRINGID_ADVENTLYCORISTRAPPED,
    STRINGID_TERRAINBECOMESDARKNESS,
    STRINGID_DARKNESSTERRAINENDS,
    STRINGID_TRANSFORMEDINTOZWEIFORM,
    STRINGID_COUNTEREDWITHSOMETHING,
    STRINGID_MIASMACOVERINGTHEFIELD,
    STRINGID_MIASMATERRAINENDS,
    STRINGID_READINGTHESTARFORMATION,
    STRINGID_FLASHINGLIGHTSKTIKESPKMN,
    STRINGID_RECOVEREDBYEXSHADOWSKY,
    STRINGID_EXSHADOWYAURAFILLED,
    STRINGID_EXSHADOWDISAPPEARED,
    STRINGID_EXSHADOWYAURADEEPEN,
    STRINGID_PKMNSTATSHIGHTENED,
    STRINGID_GATHERINGENERGYINTHESKY,
    STRINGID_CALLINGFRIENDANDBEATUP,
    STRINGID_CALLINGFRIENDFAILED,
    STRINGID_ATTACKERABILITYSTATDROP,
    STRINGID_POKEMONMADELASTWISH,
    STRINGID_POKEMONRECOVEREDFROMLASTWISH,
    STRINGID_WALLMASTERALSOCALLEDLIGHTSCREEN,
    STRINGID_WALLMASTERALSOCALLEDREFLECT,
    STRINGID_WALLMASTERALSOCALLEDSAFEGUARD,
    STRINGID_WALLMASTERALSOCALLEDMIST,
    STRINGID_DEVOURHEAL,
    STRINGID_STATINCREASEPREVENTEDBYSTASISGAZE,
    STRINGID_FULLYCHARGEDABILITY,
    STRINGID_ABILITYPREVENTPPREDUCTION,
    STRINGID_GRACEOFDREAMRAISEDSTAT,
    STRINGID_PKMNSURROUNDEDWITHFLOWERSOFDREAM,
    STRINGID_HEALINGSAINTHEALS,
    STRINGID_HEALINGSAINTHEALSBUTBLOCKED,
    STRINGID_PKMNRAISESATTACKWITH,
    STRINGID_PKMNRAISESSPATTACKWITH,
    STRINGID_FAINTINONE,
    STRINGID_COUNT
};
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_EX_SHADOW_SKY,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_EX_SHADOW_SKY,
};
...
// gTransformHitCallingFriendUsedStringIds
enum TransformHitCallingFriendUsedStringID
{
    B_MSG_CALLING_FRIEND,
    B_MSG_CALLING_FRIEND_FAILED,
};
...
enum SwitchInAbilityStringID
{
	...
	B_MSG_SWITCHIN_FANTASY_BREAKER,
	B_MSG_SWITCHIN_TIME_JACKER,
};
...
enum TerrainStringID
{
	...
	B_MSG_UBW_END,
    B_MSG_TERRAIN_END_DARKNESS,
    B_MSG_TERRAIN_END_MIASMA,
    B_MSG_TERRAIN_COUNT
};
...
{
    B_MSG_SET_TRICK_ROOM = (B_MSG_TERRAIN_SET_MIASMA + 1),
...
enum __attribute__((packed)) WrappedStringID
{
	...
	B_MSG_WRAPPED_ADVENT_LYCORIS,
    B_MSG_WRAPPED_CLASSIC_BIND,
    B_MSG_WRAPPED_CLASSIC_WRAP,
    B_MSG_WRAPPED_CLASSIC_FIRE_SPIN,
    B_MSG_WRAPPED_CLASSIC_CLAMP,
    B_MSG_WRAPPED_CLASSIC_WHIRLPOOL,
    NUM_TRAPPING_MOVES,
};
...
enum DamageNonTypesStartStringID
{
	...
	B_MSG_TRAPPED_IN_THE_WORLD_END_GARDEN,
};
...
enum DamageNonTypesDmgStringID
{
    ...
    B_MSG_HURT_BY_WORLD_END_GARDEN,
};

// gFlufficationUsedStringIds
enum FlufficationUsedStringID
{
    B_MSG_FLUFFIED,
    B_MSG_FLUFFICATION_FAILED,
};
