...
enum __attribute__((packed)) Ability
{
    ...
    // Custom
    ABILITY_OFFICIAL_END = ABILITY_POISON_PUPPETEER,
    ABILITY_ULTRA_EGO = (ABILITY_OFFICIAL_END + 1),
    ABILITY_MAKAI_GODDESS = (ABILITY_OFFICIAL_END + 2),
    ABILITY_SHICHININ_MISAKI = (ABILITY_OFFICIAL_END + 3),
    ABILITY_SCARY_GLANCE = (ABILITY_OFFICIAL_END + 4),
    ABILITY_DIMENSION_SEER = (ABILITY_OFFICIAL_END + 5),
    ABILITY_DOLL_WALL = (ABILITY_OFFICIAL_END + 6),
    ABILITY_DIVINE_HAND = (ABILITY_OFFICIAL_END + 7),
    ABILITY_TIME_JACKER = (ABILITY_OFFICIAL_END + 8),
    ABILITY_GRIMOIRE_USER = (ABILITY_OFFICIAL_END + 9),
    ABILITY_ILLUSIONARY_GIRL = (ABILITY_OFFICIAL_END + 10),
    ABILITY_SKILLED_MAGICIAN = (ABILITY_OFFICIAL_END + 11),
    ABILITY_DELTA_FORCE_1 = (ABILITY_OFFICIAL_END + 12),
    ABILITY_DELTA_FORCE_2 = (ABILITY_OFFICIAL_END + 13),
    ABILITY_DELTA_FORCE_3 = (ABILITY_OFFICIAL_END + 14),
    ABILITY_DOUBLE_HEROINES = (ABILITY_OFFICIAL_END + 15),
    ABILITY_AUTUMN_GODDESSES = (ABILITY_OFFICIAL_END + 16),
    ABILITY_YORIGAMI_SISTERS = (ABILITY_OFFICIAL_END + 17),
    ABILITY_GREAT_BLOOMING = (ABILITY_OFFICIAL_END + 18),
    ABILITY_FANTASY_BREAKER = (ABILITY_OFFICIAL_END + 19),
    ABILITY_PURE_WHITE = (ABILITY_OFFICIAL_END + 20),
    ABILITY_MANA_DISTURPTOR = (ABILITY_OFFICIAL_END + 21),
    ABILITY_BLADE_WORKS = (ABILITY_OFFICIAL_END + 22),
    ABILITY_PRIEST_HUNTER = (ABILITY_OFFICIAL_END + 23),
    ABILITY_ADVENT = (ABILITY_OFFICIAL_END + 24),
    ABILITY_SECOND_ADVENT = (ABILITY_OFFICIAL_END + 25),
    ABILITY_HAKUREI_BARRIER = (ABILITY_OFFICIAL_END + 26),
    ABILITY_HAKUREI_MIKO = (ABILITY_OFFICIAL_END + 27),
    ABILITY_SABOTEN_CORE = (ABILITY_OFFICIAL_END + 28),
    ABILITY_PRISMA_ZWEI = (ABILITY_OFFICIAL_END + 29),
    ABILITY_KALEID_RUBY = (ABILITY_OFFICIAL_END + 30),
    ABILITY_KALEID_SAPPHIRE = (ABILITY_OFFICIAL_END + 31),
    ABILITY_ULTRA_MEDICINE = (ABILITY_OFFICIAL_END + 32),
    ABILITY_SCULPTOR_GOD = (ABILITY_OFFICIAL_END + 33),
    ABILITY_POSTER_GIRL = (ABILITY_OFFICIAL_END + 34),
    ABILITY_WORLD_END_GARDEN = (ABILITY_OFFICIAL_END + 35),
    ABILITY_FOCUS = (ABILITY_OFFICIAL_END + 36),
    ABILITY_MIRROR_WALL = (ABILITY_OFFICIAL_END + 37),
    ABILITY_MISFORTUNE_AURA = (ABILITY_OFFICIAL_END + 38),
    ABILITY_FLORA_ELVIS = (ABILITY_OFFICIAL_END + 39),
    ABILITY_FORTISSIMO = (ABILITY_OFFICIAL_END + 40),
    ABILITY_LIFE_FORCE = (ABILITY_OFFICIAL_END + 41),
    ABILITY_MULTITYPE_LEGEND = (ABILITY_OFFICIAL_END + 42),
    ABILITY_DARKNESS_SURGE = (ABILITY_OFFICIAL_END + 43),
    ABILITY_TSUBAME_GAESHI = (ABILITY_OFFICIAL_END + 44),
    ABILITY_MIASMA_SURGE = (ABILITY_OFFICIAL_END + 45),
    ABILITY_ULTRA_MEDICINE_V2 = (ABILITY_OFFICIAL_END + 46),
    ABILITY_RIDE_SUMMON = (ABILITY_OFFICIAL_END + 47),
    ABILITY_PUPPETEER = (ABILITY_OFFICIAL_END + 48),
    ABILITY_ULTRA_SEIGA = (ABILITY_OFFICIAL_END + 49),
    ABILITY_GUARD_ARMOR = (ABILITY_OFFICIAL_END + 50), // TO DO // (as Shell Armor, Battle Armor)
    ABILITY_MYSTERIOUS = (ABILITY_OFFICIAL_END + 51), // TO DO // (as Color Change)
    ABILITY_FLAWLESS = (ABILITY_OFFICIAL_END + 52), // TO DO // (as Shield Dust)
    ABILITY_GATE_KEEPER = (ABILITY_OFFICIAL_END + 53), // TO DO // (as Suction Cups)
    ABILITY_PLAY_GHOST = (ABILITY_OFFICIAL_END + 54), // TO DO // (as Wonder Guard)
    ABILITY_INFECTIOUS = (ABILITY_OFFICIAL_END + 55), // TO DO // (as Effect Spore; works on Nature-types)
    ABILITY_DIVA = (ABILITY_OFFICIAL_END + 56), // TO DO // (as Illuminate; no in-battle effect)
    ABILITY_UNZAN = (ABILITY_OFFICIAL_END + 57), // TO DO // (as Pure Power, Huge Power)
    ABILITY_POISON_BODY = (ABILITY_OFFICIAL_END + 58), // TO DO // 
    ABILITY_FIRE_VEIL = (ABILITY_OFFICIAL_END + 59), // TO DO // 
    ABILITY_WALL_OF_ICE = (ABILITY_OFFICIAL_END + 60), // TO DO // Halves damage taken from Fire and Ice moves.
    ABILITY_HI_STRENGTH = (ABILITY_OFFICIAL_END + 61), // TO DO // (as Hyper Cutter)
    ABILITY_COLLECTOR = (ABILITY_OFFICIAL_END + 62), // TO DO // (as Sticky Hold)
    ABILITY_MAINTENANCE = (ABILITY_OFFICIAL_END + 63), // TO DO // (as Shed Skin)
    ABILITY_SPRING_CHARM = (ABILITY_OFFICIAL_END + 64), // TO DO // (as Marvel Scale)
    ABILITY_STRANGE_MIST = (ABILITY_OFFICIAL_END + 65), // TO DO // (as Liquid Ooze)
    ABILITY_INNER_POWER = (ABILITY_OFFICIAL_END + 66), // TO DO // When below 1/3 HP, STAB moves do +50% damage.
    ABILITY_MAGIC_BARRIER = (ABILITY_OFFICIAL_END + 67), // TO DO // Prevents stat drops
    ABILITY_HISOUTEN = (ABILITY_OFFICIAL_END + 68), // TO DO // (as Air Lock)
    ABILITY_RECOLLECTION = (ABILITY_OFFICIAL_END + 69), // TO DO // ---
    ABILITY_INVERSE_FUNCTION = (ABILITY_OFFICIAL_END + 70), // TO DO // ---
    ABILITY_LUNACY = (ABILITY_OFFICIAL_END + 71), // TO DO // Boosts a random stat on entry.
    ABILITY_POWER_LEAK = (ABILITY_OFFICIAL_END + 72), // TO DO // Gains +1 SAtk on entry, loses 1 SAtk at end of turn.
    ABILITY_HIBERNATION = (ABILITY_OFFICIAL_END + 73), // TO DO // Regains 1/8 HP at end of turn when asleep.
    ABILITY_CHEERFUL = (ABILITY_OFFICIAL_END + 74), // TO DO // (as Multiscale)
    ABILITY_STONEWORKER = (ABILITY_OFFICIAL_END + 75), // TO DO // Boosts Earth damage by 50%.
    ABILITY_WINTER_GIFT = (ABILITY_OFFICIAL_END + 76), // TO DO // During Hail, +50% boost to SAtk/SDef.
    ABILITY_PURE_FURIES = (ABILITY_OFFICIAL_END + 77), // TO DO // --- (was mold breaker)
    ABILITY_PURE_ENIGMA = (ABILITY_OFFICIAL_END + 78), // TO DO // Doubles Atk, Def, SAtk, SDef, and Speed. (+50% if user is not Okina).
    ...
    ABILITY_CONTAGION = (ABILITY_OFFICIAL_END + 82), // TO DO // (as Mummy)
    ABILITY_DOLL_SKEWER = (ABILITY_OFFICIAL_END + 83), // TO DO // 1/8 damage on contact (as modern Rough Skin)
    ABILITY_LECTURE = (ABILITY_OFFICIAL_END + 84), // TO DO // Lowers foe's Speed when damaged by any move and HP > 0. Blocked by Soundproof.
    ABILITY_DOUR_ECHO = (ABILITY_OFFICIAL_END + 85), // TO DO // Whenever a sound move is used, lower foe's higher attacking stat.
    ABILITY_MANIC_ECHO = (ABILITY_OFFICIAL_END + 86), // TO DO // Whenever a sound move is used, raise own higher attacking stat.
    ABILITY_JEALOUSY = (ABILITY_OFFICIAL_END + 87), // TO DO // If no held item, +50% Def/SDef against attackers with held items. Won't pick up items.
    ABILITY_PRIDE = (ABILITY_OFFICIAL_END + 88), // TO DO // If foe uses a recovery status move, raise own SAtk.
    ABILITY_WALL_MASTER = (ABILITY_OFFICIAL_END + 89), // TO DO // If multiple of Reflect, Light Screen, Mist, and Safeguard are known, uses all simultaneously.
    ABILITY_CATALYST = (ABILITY_OFFICIAL_END + 90), // TO DO // Opponents take an additional 1/8 HP damage from poison/toxic status.
    ABILITY_WIDE_HAT = (ABILITY_OFFICIAL_END + 91), // TO DO // (as Overcoat)
    ABILITY_TWIN_BODY = (ABILITY_OFFICIAL_END + 92), // TO DO // Uses damaging moves twice at 60% power.
    ABILITY_GOURMAND = (ABILITY_OFFICIAL_END + 93), // TO DO // Eats stat-boosting berries immediately, and other 25% HP berries when at 50% HP.
    ABILITY_BELLIGERENT = (ABILITY_OFFICIAL_END + 94), // TO DO // (as Tinted Lens)
    ABILITY_BLANK_CARD = (ABILITY_OFFICIAL_END + 95), // TO DO // Copies Ability of last party member. Won't copy Trace, Play Ghost, Pure Enigma, or itself.
    ...
    ABILITY_YIN_AND_YANG = (ABILITY_OFFICIAL_END + 107), // TO DO // When using weaker attacking stat, +30% power. Always takes effect if stats are tied.
    ABILITY_ARSONIST = (ABILITY_OFFICIAL_END + 108), // TO DO // Boosts Fire move power by 50%.
    ...
    ABILITY_LOGICIAN = (ABILITY_OFFICIAL_END + 111), // TO DO // Boosts Reason move power by 50%.
    ABILITY_TIME_CONTROL = (ABILITY_OFFICIAL_END + 112), // TO DO // All moves gain priority.
    ABILITY_MY_REALM = (ABILITY_OFFICIAL_END + 113), // TO DO // Sets (or clears) Trick Room for 5 turns on entry.
    ABILITY_SWORDMASTER = (ABILITY_OFFICIAL_END + 114), // TO DO // Boosts priority move power by 50%.
