...
extern const u8 BattleScript_SuccessBallThrow_NoMusic[];
...
extern const u8 BattleScript_DourEchoActivates[];
extern const u8 BattleScript_ManicEchoActivates[];
extern const u8 BattleScript_LastCadenzaActivates[];
...
extern const u8 BattleScript_DeusExMachinaDoomDesireFailed[];
