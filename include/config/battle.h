...
#define B_FLAG_NO_RUNNING           FLAG_NO_RUNNING_AWAY    // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
...
#define NUM_BEEPS_GEN_LATEST            1                    // Loops 4 times
...
// custom stuff
#define B_INTRO_SLIDE_SPEED    (10) // Controls how fast the sliding into battle intro goes.
