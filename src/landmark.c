...
{
    {MAPSEC_GENSOKYO_KOURINDOU, 2, Landmarks_Route103_2},
    {MAPSEC_GENSOKYO_MUENZUKA, 0, Landmarks_Route104_0},
    {MAPSEC_GENSOKYO_MUENZUKA, 1, Landmarks_Route104_1},
    {MAPSEC_GENSOKYO_HAKUGYOKUROU, 0, Landmarks_Route105_0},
    {MAPSEC_GENSOKYO_MORIYA_SHRINE, 1, Landmarks_Route106_1},
    {MAPSEC_GENSOKYO_CHIREIDEN, 0, Landmarks_Route108_0},
    {MAPSEC_GENSOKYO_PALENQUIN_SHIP, 0, Landmarks_Route109_0},
    {MAPSEC_GENSOKYO_SANZU_RIVER, 0, Landmarks_Route110_0},
    {MAPSEC_GENSOKYO_SANZU_RIVER, 1, Landmarks_Route110_1},
    {MAPSEC_GENSOKYO_SANZU_RIVER, 2, Landmarks_Route110_2},
    {MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN, 0, Landmarks_Route111_0},
    {MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN, 1, Landmarks_Route111_1},
    {MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN, 2, Landmarks_Route111_2},
    {MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN, 3, Landmarks_Route111_3},
    {MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN, 4, Landmarks_Route111_4},
    {MAPSEC_JAVA_KEMBANG_TOWN, 0, Landmarks_Route112_0},
    {MAPSEC_JAVA_KEMBANG_TOWN, 1, Landmarks_Route112_1},
    {MAPSEC_GENSOKYO_EIENTEI, 1, Landmarks_Route113_1},
    {MAPSEC_GENSOKYO_ANIMAL_REALM, 1, Landmarks_Route114_1},
    {MAPSEC_GENSOKYO_ANIMAL_REALM, 2, Landmarks_Route114_2},
    {MAPSEC_GENSOKYO_ANIMAL_REALM, 3, Landmarks_MeteorFalls},
    {MAPSEC_JAVA_NEO_BANJAR_CITY, 0, Landmarks_MeteorFalls},
    {MAPSEC_JAVA_NEO_BANJAR_CITY, 1, Landmarks_MeteorFalls},
    {MAPSEC_GENSOKYO_FANTASY_WORLD, 1, Landmarks_Route116_1},
    {MAPSEC_GENSOKYO_FANTASY_WORLD, 2, Landmarks_Route116_2},
    {MAPSEC_GENSOKYO_DREAM_WORLD, 2, Landmarks_Route117_2},
    {MAPSEC_GENSOKYO_LUNAR_CAPITAL, 1, Landmarks_Route119_1},
    {MAPSEC_GENSOKYO_FANTASY_LEAGUE, 0, Landmarks_Route120_0},
    {MAPSEC_GENSOKYO_FANTASY_LEAGUE, 2, Landmarks_Route120_2},
    {MAPSEC_YYYI_SEA_OF_TREES1, 2, Landmarks_Route121_2},
    {MAPSEC_YYYI_SEA_OF_FLAME1, 0, Landmarks_Route122_0},
    {MAPSEC_KEY_ILLUSIONARY_WORLD1, 0, Landmarks_Route123_0},
    {MAPSEC_YYYI_SEA_OF_FLAME1, 1, Landmarks_Route122_0},
    {MAPSEC_JAVA_YOGYAKARTA, 7, Landmarks_Route124_7},
    {MAPSEC_JAVA_SOLO, 2, Landmarks_Route125_2},
    {MAPSEC_JAVA_JAKARTA, 1, Landmarks_Route128_1},
    {MAPSEC_JAVA_MALANG, 1, Landmarks_Route131_1},
    {MAPSEC_JAVA_DEVATA_ISLETS, 0, Landmarks_OceanCurrent},
    {MAPSEC_JAVA_DEVATA_ISLETS, 1, Landmarks_OceanCurrent},
    {MAPSEC_JAVA_KASEPUHAN_TOWN, 0, Landmarks_OceanCurrent},
    {MAPSEC_JAVA_KASEPUHAN_TOWN, 1, Landmarks_OceanCurrent},
    {MAPSEC_JAVA_KASEPUHAN_TOWN, 2, Landmarks_OceanCurrent},
    {MAPSEC_JAVA_CILA_PRISON_TOWN, 0, Landmarks_OceanCurrent},
    {MAPSEC_JAVA_CILA_PRISON_TOWN, 1, Landmarks_OceanCurrent},
    {MAPSEC_JAVA_CILA_PRISON_TOWN, 2, Landmarks_Route134_2},
    {MAPSEC_JOHTO_ROUTE_31, 2, Landmarks_MtChimney_2},
    {MAPSEC_NONE, 0, NULL},
};
