...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNSAPPEDBYLEECHSEED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s health is sapped by Mistletoe Seed!"),
    ...
    [STRINGID_PKMNTRANSFORMEDINTO]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} transformed!"),
    ...
    [STRINGID_PKMNSHEDLEECHSEED]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shed Mistletoe Seed!"), //not in gen 5+, generic rapid spin?
    ...
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("??? used {B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_PC_DS1FWPCMH_SEQ_BGM20}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER_NO_MUSIC]      = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught spectacularly!\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("???: OK, That's good!{WAIT_SE}{PLAY_BGM MUS_PC_DS1FWPCMH_SEQ_BGM20}{PAUSE 127}"),
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("I guess it's the time to capture it!"),
    ...
    [STRINGID_SLOWSTARTENTERS]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is still gathering energy!"),
    [STRINGID_SLOWSTARTEND]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} finally got its act together and became stronger!"),
    ...
    [STRINGID_MEGAEVOEVOLVED]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has transformed into a stronger form!"),
    ...
    [STRINGID_FAIRYAURAENTERS]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is radiating a divine aura!"),
    ...
    [STRINGID_NEUTRALIZINGGASENTERS]                = COMPOUND_STRING("8-bit Sensation causes abilities on the field nullified!"),
    [STRINGID_NEUTRALIZINGGASOVER]                  = COMPOUND_STRING("The effects of 8-bit Sensation wore off!"),
    ...
    [STRINGID_PKMNMADESHELLGLEAM]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} distorts type matchups!"),
    ...
    [STRINGID_TIMEJACKERENTERS]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is making the time wierd!"),
    ...
    [STRINGID_PKMNCUTSACCWITH]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nlowers {B_DEF_NAME_WITH_PREFIX}'s Accuracy!"),
    [STRINGID_FLORAELVISSAFEGUARD]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} activates Safeguard!"),
    [STRINGID_PKMNRAISEDATTACK]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY}\nraised its attack!"),
    ...
    [STRINGID_WALLMASTERALSOCALLEDLIGHTSCREEN]      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} allowed {B_ATK_NAME_WITH_PREFIX} to use Light Screen!"),
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_UBW_SET]              = STRINGID_UNLIMITEDKRISWORKS,
    [B_MSG_TERRAIN_SET_DARKNESS] = STRINGID_TERRAINBECOMESDARKNESS,
    [B_MSG_TERRAIN_SET_MIASMA]   = STRINGID_MIASMACOVERINGTHEFIELD,
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_UBW_END] = STRINGID_UBWFADED,
    [B_MSG_TERRAIN_END_DARKNESS] = STRINGID_DARKNESSTERRAINENDS,
    [B_MSG_TERRAIN_END_MIASMA] = STRINGID_MIASMATERRAINENDS,
};
...
//    [B_MSG_WRAPPED_CLASSIC_BIND]        = STRINGID_PKMNSQUEEZEDBYBIND,     // MOVE_CLASSIC_BIND
//    [B_MSG_WRAPPED_CLASSIC_WRAP]        = STRINGID_PKMNWRAPPEDBY,          // MOVE_CLASSIC_WRAP
//    [B_MSG_WRAPPED_CLASSIC_FIRE_SPIN]   = STRINGID_PKMNTRAPPEDINVORTEX,    // MOVE_CLASSIC_FIRE_SPIN
//    [B_MSG_WRAPPED_CLASSIC_CLAMP]       = STRINGID_PKMNCLAMPED,            // MOVE_CLASSIC_CLAMP
//    [B_MSG_WRAPPED_CLASSIC_WHIRLPOOL]   = STRINGID_PKMNTRAPPEDINVORTEX,    // MOVE_CLASSIC_WHIRLPOOL
};
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_LIGHT_ORB_UP]       = STRINGID_ITISRAINING
};
...
const u8 gText_BadEgg[] = _("Hacked!");
