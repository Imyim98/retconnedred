...
static int GetTypeEffectivenessPoints(enum Move move, int targetSpecies, int mode)
{
    ...
    if (defAbility == ABILITY_LEVITATE && moveType == TYPE_NEW_EARTH)
    {
    ...
    else
    {
        ...
        if ((defAbility == ABILITY_WONDER_GUARD || defAbility == ABILITY_PLAY_GHOST) && typeEffectiveness1 != TYPE_x1 && typeEffectiveness2 != TYPE_x1)
            typePower = 0;
    }
