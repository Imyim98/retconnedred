...
#if P_TERA_FORMS
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_TEAL_TERA,        TYPE_NEW_NATURE},
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_WELLSPRING_TERA,  TYPE_NEW_WATER},
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_HEARTHFLAME_TERA, TYPE_NEW_FIRE},
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_CORNERSTONE_TERA, TYPE_NEW_EARTH},
#endif
    {FORM_CHANGE_END_BATTLE},
    {FORM_CHANGE_TERMINATOR},
};
