...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_NEW_ICE, TYPE_NEW_METAL),
        .catchRate = 45,
        .expYield = 64,
        .evYield_SpAttack = 1,
        ...
        .abilities = { ABILITY_SECOND_ADVENT, ABILITY_NONE, ABILITY_CHLOROPHYLL },
        ...
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 14 : 0,
        ...
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 32) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 16 : 0,
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_NEW_HEART, TYPE_NEW_NATURE),
        .catchRate = 45,
        .expYield = 160,
        .evYield_HP = 3,
        .genderRatio = MON_GENDERLESS,
        ...
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_NONE, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Madoka"),
        ...
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 12 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 2),
            ANIMCMD_FRAME(1, 46),
            ANIMCMD_FRAME(0, 10),
...
//        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_CHARMELEON}),
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_WATER, TYPE_NEW_METAL),
        .catchRate = 45,
        .expYield = 150,
        .evYield_Defense = 1,
        .genderRatio = MON_GENDERLESS,
        ...
        .abilities = { ABILITY_FORTISSIMO, ABILITY_SHARPNESS, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sayaka"),
        .cryId = CRY_SQUIRTLE,
        ...
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 64),
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MAGNEZONE, CONDITIONS({IF_IN_MAPSEC, MAPSEC_JOHTO_ROUTE_36})},
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .types = MON_TYPES(TYPE_NEW_REASON),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 340,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DOLL_WALL, ABILITY_NONE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Alice"),
        .cryId = CRY_MEWTWO,
    ...
    [SPECIES_MEWTWO_MEGA_Y] =
    {
        ...
        .baseSpAttack  = 194,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_NEW_REASON, TYPE_NEW_DARK),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 390 : 351,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GRIMOIRE_USER, ABILITY_GRIMOIRE_USER, ABILITY_GRIMOIRE_USER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Alice"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MEW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ILLUSIONARY_GIRL, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Mew"),
        .cryId = CRY_MEW,
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_SWING_CONVEX : ANIM_V_SQUISH_AND_BOUNCE,
