...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DRILL_PECK] =  // MOVE_NEW_WING_SCREW Edited name, effect, power, PP
    {
        .name = COMPOUND_STRING("Wing Screw"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_TEAM] =  // MOVE_NEW_ILLUSION_STEP Edited name
    {
        .name = COMPOUND_STRING("Illusion Step"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWEET_KISS] =  // MOVE_NEW_ANGELS_KISS name, acc
    {
        ...
        .effect = EFFECT_CONFUSE,
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_NEW_HEART : TYPE_NEW_ILLUSION,
        .accuracy = 90,
        .pp = 10,
        .target = TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_MORNING_SUN] =  // MOVE_NEW_DIVINE_LIGHT Reworked
    {
    ...
    [MOVE_MOONLIGHT] =  // MOVE_NEW_LUNATIC Reworked
    {
        ...
        .effect = EFFECT_HIT,
        .power = 120,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_NEW_METAL : TYPE_NEW_ILLUSION,
        .accuracy = 80,
        .pp = 5,
        .target = TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_CROSS_CHOP] =  // MOVE_NEW_AWAKENED_STRIKE Reworked
    {
    ...
    {
        .name = COMPOUND_STRING("Shadow Dance"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Mud Turret"),
        .description = COMPOUND_STRING(
...
//        .sketchBanned = (B_SKETCH_BANS >= GEN_9),
    ...
    [MOVE_STRUGGLE_BUG] =  // MOVE_NEW_CORNERED_CAT Name desc power pp effect category
    {
        .name = COMPOUND_STRING("Cornered Cat"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Draining Stab"),
        .description = sMegaDrainDescription,
        .effect = EFFECT_ABSORB,
        .power = 75,
        .type = TYPE_NEW_BEAST,
    ...
    [MOVE_SEARING_SHOT] =  // MOVE_NEW_RAIL_GUN Edited name desc power
    {
        .name = COMPOUND_STRING("Rail Gun"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PETAL_BLIZZARD] =  // MOVE_NEW_SAKURA_CYCLONE Edited name power
    {
        .name = COMPOUND_STRING("Sakura Cyclone"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRAFTY_SHIELD] =  // MOVE_NEW_STATUS_BARRIER Edited name
    {
    ...
    [MOVE_BEAK_BLAST] =  // MOVE_NEW_BURNING_FEATHER
    {
    ...
    [MOVE_PSYCHIC_FANGS] =  // MOVE_NEW_MAGIC_FANGS Edited name desc
    {
        .name = COMPOUND_STRING("Magic Fangs"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIQUIDATION] =  // MOVE_NEW_AQUA_BREAK Edited
    {
    ...
    [MOVE_SUNSTEEL_STRIKE] =   // MOVE_NEW_COMPLETE_SMASH Edited name
    {
    ...
    [MOVE_MULTI_ATTACK] =  // MOVE_NEW_PROJECTION_PUNCH Edited 
    {
        .name = COMPOUND_STRING("Projection Punch"),
        .description = COMPOUND_STRING(
            "The move type is based\n"
            "on the user's type."),
        .effect = EFFECT_CHANGE_TYPE_ON_ITEM,
    ...
    [MOVE_DRAGON_DARTS] =  // MOVE_NEW_SACRED_NEEDLES Edited desc
    {
        .name = COMPOUND_STRING("Sacred Needles"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEEL_ROLLER] =  // MOVE_NEW_FIELD_DESTROYER Edited name power
    {
        .name = COMPOUND_STRING("Field Destroyer"),
        .description = COMPOUND_STRING(
            "Destroys existing field.\n"
            "Fails if there is no field."),
    ...
    [MOVE_TERRAIN_PULSE] =  // MOVE_NEW_PULSE_OF_NATURE Edited name power
    {
        .name = COMPOUND_STRING("Pulse of Nature"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_ARROWS] =  // MOVE_NEW_ARROW_WINGS Edited name
    {
    ...
    [MOVE_POPULATION_BOMB] =  // MOVE_NEW_PAPER_SLICE Edited name
    {
...
// ============= Start Added Custom Moves ===================
    ...
    [MOVE_ADVENT_LYCORIS] =  // Added
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_WRAP,
            .multistring.wrapped = B_MSG_WRAPPED_ADVENT_LYCORIS,
        }),
        .contestEffect = CONTEST_EFFECT_DONT_EXCITE_AUDIENCE,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
    ...
    [MOVE_SPIN_SLASH] =
    {
        .name = COMPOUND_STRING("Spin Slash"),
        .description = COMPOUND_STRING(
            "Slashes with claws, etc. Has\n"
            "a high critical-hit ratio."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_PETIT_THUNDER] =  // to do anim
    {
        .name = COMPOUND_STRING("Petit Thunder"),
        .description = COMPOUND_STRING(
            "An electrical attack that\n"
    ...
    [MOVE_MEGA_BLASTER] =  // to do anim
    {
        .name = COMPOUND_STRING("Mega Blaster"),
        .description = COMPOUND_STRING(
            "A decent electrical attack\n"
            "that may paralyze or flinch."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_HORN_BUSTER] =  // to do anim
    {
        .name = COMPOUND_STRING("Horn Buster"),
        .description = COMPOUND_STRING(
            "Rams using an electrified horn\n"
            "that may paralyze or flinch."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_NEW_ELECTRIC,
    ...
    {
        .name = COMPOUND_STRING("Giga Scissor Claw"),
        .description = COMPOUND_STRING(
            "Uses plasma sword. High crit.\n"
            "May burn or flinch."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_POISON_IVY] =
    {
        .name = COMPOUND_STRING("Poison Ivy"),
        .description = COMPOUND_STRING(
            "Strikes the foe with\n"
            "slender, whiplike vines."),
        .pp = 35,
    ...
    {
        .name = COMPOUND_STRING("Prickly Bang-Bang"),
        .description = COMPOUND_STRING(
            "Attacks with thorny arms.\n"
            "May cause poisoning."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_FLOWER_CANNON] =  // to do anim
    {
        .name = COMPOUND_STRING("Flower Cannon"),
        .description = COMPOUND_STRING(
            "Shots a floral-powered energy\n"
            "ball. May lower Sp. Def."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_NEW_NATURE,
        .accuracy = 100,
    ...
    [MOVE_ROSES_RAPIER] =  // Edited power acc
    {
        .name = COMPOUND_STRING("Roses Rapier"),
        .description = COMPOUND_STRING(
            "Stabs the foe using thorny\n"
            "rose stem. May influate the foe."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_NEW_NATURE,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("F. Temptation"),
        .description = COMPOUND_STRING(
            "Release a blast of love energy.\n"
            "May influate the foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_NEW_HEART,
        .accuracy = 90,
    ...
    [MOVE_TURBO_PECKER] =
    {
        .name = COMPOUND_STRING("Turbo Pecker"),
        .description = COMPOUND_STRING(
            "Attacks the foe with a\n"
            "jabbing beak, etc."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_METEOR_WING] =  // to do anim
    {
        .name = COMPOUND_STRING("Meteor Wing"),
        .description = COMPOUND_STRING(
            "Sends multiple small fireball\n"
            "to the foes. May burn the foes."),
        .effect = EFFECT_HIT,
        .power = 17,
        .type = TYPE_NEW_FIRE,
        .accuracy = 100,
    ...
    [MOVE_SHADOW_WING] =  // to do anim
    {
        .name = COMPOUND_STRING("Shadow Wing"),
        .description = COMPOUND_STRING(
            "Strikes the foe with\n"
            "shadow wing. Never misses."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_NEW_FIRE,
        .accuracy = 0,
    ...
    [MOVE_STARLIGHT_EXPLOSION] =  // to do anim
    {
        .name = COMPOUND_STRING("Starlight Explosion"),
        .description = COMPOUND_STRING(
            "Attack that may lower\n"
            "the foes' evasion."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_CRIMSON_FLARE] = // to do anim
    {
        .name = COMPOUND_STRING("Crimson Flare"),
        .description = COMPOUND_STRING(
            "Revives a fainted ally and\n"
            "restores half of their HP."),
        .effect = EFFECT_REVIVAL_BLESSING,
...
// ============= Start Classing Moves ===================
    ...
    [MOVE_MIKO_CHARITY] =
    {
        .name = COMPOUND_STRING("Miko Charity"),
        .description = COMPOUND_STRING(
            "Throws coins at the foe.\n"
            "Money is recovered after."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SILENCING] =
    {
        .name = COMPOUND_STRING("Silencing"),
        .description = COMPOUND_STRING(
            "Binds the target and clears\n"
            "the stat changes."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_ILLUSION,
    ...
    [MOVE_KILLER_DOLL] =
    {
        .name = COMPOUND_STRING("Killer Doll"),
        .description = COMPOUND_STRING(
            "Jabs the foe 2 to 5 times\n"
    ...
    [MOVE_HOMING_NEEDLE] =
    {
        .name = COMPOUND_STRING("Homing Needle"),
        .description = COMPOUND_STRING(
            "Throws homing needles that\n"
    ...
    [MOVE_PRIVATE_SQUARE] =
    {
        .name = COMPOUND_STRING("Private Square"),
        .description = COMPOUND_STRING(
            "Attacks inside a private\n"
            "zone. May cause freezing."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_NEW_ICE,
        .accuracy = 100,
    ...
    [MOVE_FEATHER_JAB] =
    {
        .name = COMPOUND_STRING("Feather Jab"),
        .description = COMPOUND_STRING(
            "Attacks the foe with a\n"
            "jabbing feather, etc."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_DRAGON_DRILL] =
    {
        .name = COMPOUND_STRING("Dragon Drill"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TENSION_KICK] =
    {
        .name = COMPOUND_STRING("Tension Kick"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOLL_STRINGS] =
    {
        .name = COMPOUND_STRING("Doll Strings"),
        .description = COMPOUND_STRING(
            "Spread strings on the field\n"
            "that confuses foes."),
        .effect = EFFECT_CONFUSE,
        .power = 0,
        .type = TYPE_NEW_ILLUSION,
    ...
    [MOVE_DRAGON_METEOR] =
    {
        .name = COMPOUND_STRING("Dragon Meteor"),
        .description = COMPOUND_STRING(
            "Launches dragonic flame\n"
    ...
    [MOVE_ENVY] =
    {
        .name = COMPOUND_STRING("Envy"),
        .description = COMPOUND_STRING(
            "Equalizes the user's and\n"
            "the target's health."),
        .effect = EFFECT_PAIN_SPLIT,
        .power = 0,
        .type = TYPE_NEW_DARK,
    ...
    [MOVE_ISOLATION] =
    {
        .name = COMPOUND_STRING("Isolation"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLACK_WIND] =
    {
        .name = COMPOUND_STRING("Black Wind"),
        .description = COMPOUND_STRING(
            "Envelops the foe with black\n"
            "wind. May raise all stats."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_WIND,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Artful Sacrifice"),
        .description = COMPOUND_STRING(
            "Throws doll, explodes, and\n"
    ...
    [MOVE_PAIN_FLOW] =
    {
        .name = COMPOUND_STRING("Pain Flow"),
        .description = COMPOUND_STRING(
            "An exhaust-gas attack. May\n"
            "poison, freeze, or paralyze."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_NEW_MIASMA,
        .accuracy = 80,
    ...
    [MOVE_MALLET_SMASH] =
    {
        .name = COMPOUND_STRING("Mallet Smash"),
        .description = COMPOUND_STRING(
            "Clubs the foe with a mallet.\n"
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_NEW_ILLUSION,
    ...
    [MOVE_LITTLE_LEGION] =
    {
        .name = COMPOUND_STRING("Little Legion"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Persuasion Needle"),
        .description = COMPOUND_STRING(
            "Launches sharp needles that\n"
    ...
    [MOVE_LUNA_DIAL] =
    {
        .name = COMPOUND_STRING("Luna Dial"),
        .description = COMPOUND_STRING(
            "Activates the Luna Dial.\n"
            "If it hits, freeze the foe."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_NEW_ICE,
        .accuracy = 70,
    ...
    [MOVE_WRIGGLE_KICK] =
    {
        .name = COMPOUND_STRING("Wriggle Kick"),
        .description = COMPOUND_STRING(
            "A jumping knee kick. If it\n"
            "misses, the user is hurt."),
        .power = 130,
    ...
    {
        .name = COMPOUND_STRING("Lunatic Red Eyes"),
        .description = COMPOUND_STRING(
            "Emits weird frequency waves\n"
            "that makes the foe confused."),
        .accuracy = 90,
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_NEW_REASON,
    ...
    [MOVE_POISON_BREATH] =
    {
        .name = COMPOUND_STRING("Poison Breath"),
        .description = COMPOUND_STRING(
            "Envelops the foes in a toxic\n"
            "gas that poison the target."),
        .accuracy = 85,
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_NEW_MIASMA,
    ...
    [MOVE_FOCUS_FLIGHT] =
    {
        .name = COMPOUND_STRING("Focus Flight"),
        .description = COMPOUND_STRING(
            "Focusing while flying.\n"
            "Makes stronger but slower."),
        .effect = EFFECT_CURSE,
        .power = 0,
        .type = TYPE_NEW_ILLUSION,
        .accuracy = 0,
    ...
    [MOVE_TRAIN_WRECK] =
    {
        .name = COMPOUND_STRING("Train Wreck"),
        .description = COMPOUND_STRING(
            "A train crashes into foes.\n"
            "May lower the target Defemse."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_NEW_METAL,
        .accuracy = 90,
    ...
    [MOVE_LIFE_COUNTER] =
    {
        .name = COMPOUND_STRING("Life Counter"),
        .description = COMPOUND_STRING(
            "Attacks that cuts foes\n"
            "health into half."),
        .effect = EFFECT_FIXED_PERCENT_DAMAGE,
        .power = 1,
        .type = TYPE_NEW_NETHER,
    ...
    [MOVE_MINDS_EYE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strengthen the mind. Greatly\n"
            "increases the user's attack."),
        .effect = EFFECT_SPECIAL_ATTACK_UP_2,
        .power = 0,
        .type = TYPE_NEW_HEART,
        .accuracy = 0,
    ...
    [MOVE_VOODOO_DOLL] =
    {
        .name = COMPOUND_STRING("Voodoo Doll"),
        .description = COMPOUND_STRING(
            "A move that functions\n"
            "differently for GHOSTS."),
        .effect = EFFECT_CURSE,
    ...
    {
        .name = COMPOUND_STRING("Unexplained Fever"),
        .description = COMPOUND_STRING(
            "Attack with strange virus.\n"
            "May also poison."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_NEW_MIASMA,
    ...
    [MOVE_OCCULT_DANCE] =
    {
        .name = COMPOUND_STRING("Occult Dance"),
        .description = COMPOUND_STRING(
            "A life-risking dance that\n"
            "also hurts the user."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_NEW_NETHER,
    ...
    {
        .name = COMPOUND_STRING("Invisible Fullmoon"),
        .description = COMPOUND_STRING(
            "Inflicts bad damage if used\n"
            "on a foe switching out."),
        .effect = EFFECT_PURSUIT,
    ...
    [MOVE_SPARROW_SONG] =
    {
        .name = COMPOUND_STRING("Sparrow Song"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMASHY_SMASH] =
    {
        .name = COMPOUND_STRING("Smashy Smash"),
        .description = COMPOUND_STRING(
            "Strikes the foe with a bone\n"
            "in hand 2 to 5 times."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SUNNY_MILK] =
    {
        .name = COMPOUND_STRING("Sunny Milk"),
        .description = COMPOUND_STRING(
            "Drinks hot milk to\n"
            "sharply boost Sp. Atk."),
        .effect = EFFECT_SPECIAL_ATTACK_UP_2,
    ...
    [MOVE_SUPER_EGO] = // MOVE_NEW_CLASSIC_SUPER_EGO
    {
        .name = COMPOUND_STRING("Super-Ego"),
        .description = COMPOUND_STRING(
            "For 4 turns, prevents foe\n"
            "from using last used move."),
        .accuracy = 100,
    ...
    [MOVE_PRISM_LIVE] =
    {
        .name = COMPOUND_STRING("Prism Live"),
        .description = COMPOUND_STRING(
            "A music performance that may\n"
            "increases all user's stats."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_NETHER,
        .accuracy = 100,
    ...
    [MOVE_HELLS_TOKAMAK] =
    {
        .name = COMPOUND_STRING("Hell's Tokamak"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EX_ONBASHIRA] =
    {
        .name = COMPOUND_STRING("EX-Onbashira"),
        .description = COMPOUND_STRING(
            "Rams foes using Onbashira.\n"
            "Stronger when HP is lower."),
        .effect = EFFECT_FLAIL,
        .power = 1,
        .type = TYPE_NEW_DIVINE,
        .accuracy = 100,
    ...
    [MOVE_LAEVATEIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Throws a hot flame lance.\n"
            "May lower the target's Def."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_NEW_FIRE,
        .accuracy = 80,
    ...
    [MOVE_CLASSIC_FLAMETHROWER] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SUNNY_DAY},
        .battleAnimScript = gBattleAnimMove_ClassicFlamethrower,
    },
    ...
    [MOVE_CLASSIC_MASTER_SPARK] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_ClassicHyperBeam,
    },
    ...
    [MOVE_CLASSIC_THUNDERBOLT] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_CHARGE},
        .battleAnimScript = gBattleAnimMove_ClassicThunderbolt,
    },
    ...
    [MOVE_CLASSIC_AMNESIA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Forgets about something\n"
            "and sharply raises Special."),
        .effect = EFFECT_SPATK_SPDEF_UP2,
        .power = 0,
        .type = TYPE_NEW_REASON,
        .accuracy = 0,
        .pp = 20,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_ClassicAmnesia,
    },

    [MOVE_CARD_INCLUDE] =
    {
        .name = COMPOUND_STRING("Card: <Include>"),
        .description = COMPOUND_STRING(
            "Calls a move that channeled\n"
...
//        .zMove = { .effect = Z_EFFECT_ATK_UP_1 },
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_CardInclude,
    },

    [MOVE_CARD_INCLUDE_BELLEROPHON] = // to do anim
    {
        .name = COMPOUND_STRING("Bellerophon"),
        .description = COMPOUND_STRING(
            "Strikes by riding Bellerohen.\n"
            "but lowers abilities."),
        .effect = EFFECT_PSYSHOCK,
        .power = 70,
        .type = TYPE_NEW_WIND,
    ...
    [MOVE_CARD_INCLUDE_EXCALIBUR_SPECIAL] = // to do anim
    {
        .name = COMPOUND_STRING("Excalibur"),
        .description = COMPOUND_STRING(
            "Launches energy beam from a.\n"
            "sword. Lowers accuracy."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_WIND,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_BUDDHA_PALM] = // to do anim
    {
        .name = COMPOUND_STRING("Buddha Palm"),
        .description = COMPOUND_STRING(
            "Barrage of divine punches\n"
    ...
    [MOVE_CARD_INCLUDE_ENUMA_ELISH] = // to do anim
    {
        .name = COMPOUND_STRING("Enuma Elish"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CARD_INCLUDE_SANAT_KUMARA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Blasts the foe using laser\n"
            "from UFO. Lowers Sp. Def."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_REASON,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_GAE_BOLG] =
    {
        ...
        .description = COMPOUND_STRING(
            "Throws a lance that never\n"
            "misses. Deals extra damage."),
        .effect = EFFECT_PSYSHOCK,
        .power = 70,
        .type = TYPE_NEW_METAL,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Ganryu Jima"),
        .description = COMPOUND_STRING(
            "Creates a huge wave, then\n"
            "slashes. Traps in a whirlpool"),
        .effect = EFFECT_PSYSHOCK,
        .power = 70,
        .type = TYPE_NEW_WATER,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_SECECE_MORGAN] = // to do anim
    {
        .name = COMPOUND_STRING("Secece Morgan"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CARD_INCLUDE_ZABANIYA] = // to do anim
    {
        .name = COMPOUND_STRING("Zabaniya"),
        .description = COMPOUND_STRING(
            "An attack that always crit.\n"
            "Induces various statuses."),
        .effect = EFFECT_PSYSHOCK,
        .power = 70,
        .type = TYPE_NEW_MIASMA,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_ANGRA_MANYU_CURSE] = // to do anim
    {
        .name = COMPOUND_STRING("Angra Manyu Curse"),
        .description = COMPOUND_STRING(
            "Curses of the black grail.\n"
            "Causes toxic."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_MIASMA,
    ...
    [MOVE_CARD_INCLUDE_CHARIOT_MY_LOVE] = // to do anim
    {
        .name = COMPOUND_STRING("Chariot My Love"),
        .description = COMPOUND_STRING(
            "Rams the target with love.\n"
            "Causes infatuation."),
        .effect = EFFECT_PSYSHOCK,
        .power = 70,
        .type = TYPE_NEW_HEART,
    ...
    [MOVE_CARD_INCLUDE_SAMSARA_KAMA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Draws the target into Samasara.\n"
            "Causes infatuation."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_HEART,
    ...
    {
        .name = COMPOUND_STRING("9-Live Blades Work"),
        .description = COMPOUND_STRING(
            "A high-crit attack that\n"
    ...
    {
        .name = COMPOUND_STRING("Tarasque"),
        .description = COMPOUND_STRING(
            "Saint's punches that lower\n"
    ...
    [MOVE_CARD_INCLUDE_UOMO_UNIVERSALE] = // to do anim
    {
        .name = COMPOUND_STRING("Uomo Universale"),
        .description = COMPOUND_STRING(
            "Shoots a strong energy ball\n"
            "that resets stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_CARD_INCLUDE_OPUTATESHIKE_OKIMUNPE] = // to do anim
    {
        .name = COMPOUND_STRING("Oputateshike Okimunpe"),
        .description = COMPOUND_STRING(
            "Cloaks the foe using ice, then\n"
            "slashes. Also, summons hail."),
        .effect = EFFECT_PSYSHOCK,
        .power = 70,
        .type = TYPE_NEW_ICE,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_RASHOUMON_DAIENGI] = // to do anim
    {
        .name = COMPOUND_STRING("Rashoumon Daiengi"),
        .description = COMPOUND_STRING(
            "Grabs and squishes the foe.\n"
    ...
    [MOVE_CARD_INCLUDE_KUR_KI_GAL_IRKALA] =  // Edited
    {
        .name = COMPOUND_STRING("Kur Ki Gal Irkala"),
        .description = COMPOUND_STRING(
            "A powerful fire attack that\n"
            "may inflict a burn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_CARD_INCLUDE_HIPPOGRIF] =  // to do anim
    {
        .name = COMPOUND_STRING("Hippogrif"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CARD_INCLUDE_VALKYRIE_RAGNAROG] = // to do anim
    {
        .name = COMPOUND_STRING("Valkyrie Ragnarog"),
        .description = COMPOUND_STRING(
            "Hits the target using a lot of\n"
            "energy lances. Deploys Divine Field."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_FLYING,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_NEZUMI_JOUDO] =  // to do effect 
    {
        .name = COMPOUND_STRING("Nezumi Joudo"),
        .description = COMPOUND_STRING(
            "Plays rough with the foe.\n"
            "May lower Attack."),
        .effect = EFFECT_PSYSHOCK,
        ...
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_CLEAR_SMOG, // to do tidy up + rapid spin all sides
            .chance = 100,
        }),
        .contestEffect = CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_CUTE,
    ...
    [MOVE_CARD_INCLUDE_EARTHLIGHT_STARBOW] =
    {
        ...
        .description = COMPOUND_STRING(
            "Unleashes energy blast.\n"
            "Supresses the foe's ability."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_EARTH,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Blasted Tree"),
        .description = COMPOUND_STRING(
            "Bonks foes using electrified\n"
            "hammer. May flinch the foe."),
        .effect = EFFECT_PSYSHOCK,
        .power = 70,
        .type = TYPE_NEW_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_SYSTEM_KERAUNOS] =  // to do anim
    {
        .name = COMPOUND_STRING("System Keraunos"),
        .description = COMPOUND_STRING(
            "Zaps all other {PKMN} with\n"
            "electricity. Ups Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_CARD_INCLUDE_HAMISH_AVALIM] =  // to do anim
    {
        .name = COMPOUND_STRING("Hamish Avalim"),
        .description = COMPOUND_STRING(
            "Giant stalk scatters seeds\n"
            "that drain HP every turn."),
        .effect = EFFECT_PSYSHOCK,
    ...
    [MOVE_CARD_INCLUDE_ISHA_RAA] =  // to do anim
    {
        .name = COMPOUND_STRING("Isha Raa"),
        .description = COMPOUND_STRING(
            "Traps the foe in a fierce\n"
            "cyclone. Cause confusion."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NEW_WIND,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Rayproof Kyrielight"),
        .description = COMPOUND_STRING(
            "Shoots a strong energy ball.\n"
