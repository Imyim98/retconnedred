...
const struct Tileset gTileset_TrimmedGensokyo =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_TrimmedGensokyo,
    .palettes = gTilesetPalettes_TrimmedGensokyo,
    .metatiles = gMetatiles_TrimmedGensokyo,
    .metatileAttributes = gMetatileAttributes_TrimmedGensokyo,
    .callback = NULL,
};
...
const struct Tileset gTileset_GeneralGSC =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_GeneralGSC,
    .palettes = gTilesetPalettes_GeneralGSC,
    .metatiles = gMetatiles_GeneralGSC,
    .metatileAttributes = gMetatileAttributes_GeneralGSC,
    .callback = NULL,
};

const struct Tileset gTileset_RoofGSC =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_RoofGSC,
    .palettes = gTilesetPalettes_RoofGSC,
    .metatiles = gMetatiles_RoofGSC,
