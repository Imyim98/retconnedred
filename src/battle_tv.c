...
#define power arg2
    case PTS_WATER_SPORT:
        ...
        if (tvPtr->pos[defSide][0].waterSportMonId != -(tvPtr->pos[defSide][1].waterSportMonId) && GetMoveType(move) == TYPE_NEW_FIRE)
        {
    ...
    case PTS_MUD_SPORT:
        ...
        if (tvPtr->pos[defSide][0].mudSportMonId != -(tvPtr->pos[defSide][1].mudSportMonId) && GetMoveType(move) == TYPE_NEW_ELECTRIC)
        {
