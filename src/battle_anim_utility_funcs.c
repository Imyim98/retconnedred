...
void AnimTask_SetCamouflageBlend(u8 taskId)
{
    ...
    case BATTLE_ENVIRONMENT_GRASS_MONO:
    case BATTLE_ENVIRONMENT_LONG_GRASS_MONO:
    case BATTLE_ENVIRONMENT_SAND_MONO:
    case BATTLE_ENVIRONMENT_UNDERWATER_MONO:
    case BATTLE_ENVIRONMENT_WATER_MONO:
    case BATTLE_ENVIRONMENT_POND_MONO:
    case BATTLE_ENVIRONMENT_MOUNTAIN_MONO:
    case BATTLE_ENVIRONMENT_CAVE_MONO:
    case BATTLE_ENVIRONMENT_BUILDING_MONO:
    case BATTLE_ENVIRONMENT_PLAIN_MONO:
        gBattleAnimArgs[4] = RGB_WHITE;
        break;
