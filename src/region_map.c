...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_GENSOKYO_ANIMAL_REALM,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_GENSOKYO_ANIMAL_REALM,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_JAVA_NEO_BANJAR_CITY,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_JAVA_NEO_BANJAR_CITY,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_GENSOKYO_FANTASY_WORLD,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_GENSOKYO_FANTASY_WORLD,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_GENSOKYO_MAKAI,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_GENSOKYO_MAKAI,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_GENSOKYO_HAKUGYOKUROU,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_GENSOKYO_HAKUGYOKUROU,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_JAVA_SOLO,
    [ABNORMAL_WEATHER_ROUTE_125_EAST  - 1] = MAPSEC_JAVA_SOLO,
    [ABNORMAL_WEATHER_ROUTE_127_NORTH - 1] = MAPSEC_JAVA_SURABAYA,
    [ABNORMAL_WEATHER_ROUTE_127_SOUTH - 1] = MAPSEC_JAVA_SURABAYA,
    [ABNORMAL_WEATHER_ROUTE_129_WEST  - 1] = MAPSEC_JOHTO_ROUTE_48_POKEMON_CENTER,
    [ABNORMAL_WEATHER_ROUTE_129_EAST  - 1] = MAPSEC_JOHTO_ROUTE_48_POKEMON_CENTER
};
...
{
    MAPSEC_JOHTO_SINJOH_RUINS,
    MAPSEC_YYYI_SEA_OF_TREES1,
    MAPSEC_YYYI_SEA_OF_TREES2,
    MAPSEC_YYYI_SEA_OF_TREES3,
    MAPSEC_YYYI_SEA_OF_TREES4,
    MAPSEC_YYYI_SEA_OF_TREES5,
    MAPSEC_YYYI_SEA_OF_FLAME1,
    MAPSEC_YYYI_SEA_OF_FLAME2,
    MAPSEC_YYYI_SEA_OF_FLAME3,
    MAPSEC_YYYI_SEA_OF_FLAME4,
    MAPSEC_YYYI_SEA_OF_FLAME5,
    MAPSEC_YYYI_DIVINE_TREE,
    MAPSEC_KEY_ILLUSIONARY_WORLD1,
    MAPSEC_KEY_ILLUSIONARY_WORLD2,
    MAPSEC_KEY_ILLUSIONARY_WORLD3,
    MAPSEC_KEY_ILLUSIONARY_WORLD4,
    MAPSEC_KEY_ILLUSIONARY_WORLD5,
    MAPSEC_BGHS_DIVINE_TREE,
    MAPSEC_ETC_AURORA_CURTAIN,
    MAPSEC_ETC_DIMENSIONAL_RIFT,
    MAPSEC_ETC_DENLINER,
    MAPSEC_ETC_DIGITAL_WORLD,
    MAPSEC_ETC_HOSPITAL,
    MAPSEC_ETC_VOID,
    MAPSEC_ETC_ENDING,
    MAPSEC_JAVA_MT_MERAPI,
    MAPSEC_JAVA_NORTHERN_PASS,
    MAPSEC_JAVA_SOUTHERN_PASS,
    MAPSEC_JAVA_TRAPPY_PASS,
    MAPSEC_JAVA_SEA_BREAK_PASS,
    MAPSEC_JAVA_MIDDLE_PASS,
    MAPSEC_JAVA_EASTERN_PASS,
    MAPSEC_JAVA_WESTERN_PASS,
    MAPSEC_JAVA_POJOK_CLIFF,
    MAPSEC_JAVA_SULTAN_PALACE,
    MAPSEC_JAVA_SUNAN_PALACE,
    MAPSEC_JAVA_SURABAYA_ZONE,
    MAPSEC_JAVA_THOUSAND_DOORS,
    MAPSEC_JAVA_MT_MERAPI_CAVE,
    MAPSEC_JAVA_NATIONAL_MONUMENT,
    MAPSEC_JAVA_MT_BROMO,
    MAPSEC_JAVA_MISTIC_WOODS,
    MAPSEC_JAVA_NORTH_LINE_ROUTE,
    MAPSEC_JAVA_SOUTH_LINE_ROUTE,
    MAPSEC_JOHTO_ROUTE_51,
    MAPSEC_JOHTO_SEA_DRAGON_PALACE,
    MAPSEC_JAVA_NORTH_JABO_ROUTE,
    MAPSEC_JAVA_NORTH_TABEC_ROUTE,
    MAPSEC_JAVA_EAST_SEA_ROUTE1,
    MAPSEC_JAVA_EAST_SEA_ROUTE2,
    MAPSEC_JAVA_MYSTIC_WOODS,
    MAPSEC_JAVA_NATURE_PRESERVE,
    MAPSEC_JAVA_SEA_OF_SAND,
    MAPSEC_0XDE,
    MAPSEC_0XDF,
    MAPSEC_ETC_ANOTHER_WORLD,
    MAPSEC_ETC_WORLD_OF_POKEMON,
    MAPSEC_ETC_WORLD_OF_MOEMON,
    MAPSEC_ETC_WORLD_OF_KEY_VISUAL_ARTS,
    MAPSEC_ETC_WORLD_OF_TOUHOU,
    MAPSEC_ETC_WORLD_OF_SEIHOU,
    MAPSEC_ETC_WORLD_OF_HEROES,
    MAPSEC_ETC_WORLD_OF_BATTLE_GIRL,
    MAPSEC_ETC_WORLD_OF_PRETTY_CURE,
    MAPSEC_ETC_WORLD_OF_KAMEN_RIDER,
    MAPSEC_ETC_WORLD_OF_NEGATIVE,
    MAPSEC_0XEB,
    MAPSEC_0XEC,
    MAPSEC_0XED,
    MAPSEC_0XEE,
...
{
    [MAPSEC_JOHTO_TWINRIVER_CITY] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_JOHTO_TWINRIVER_CITY_MC_HOUSE_2F_MALE},
    [MAPSEC_JOHTO_NEW_BARK_TOWN] = {MAP_GROUP(MAP_OLDALE_TOWN), MAP_NUM(MAP_OLDALE_TOWN), HEAL_LOCATION_JOHTO_NEW_BARK_TOWN},
    [MAPSEC_JOHTO_CHERRYGROVE_CITY] = {MAP_GROUP(MAP_DEWFORD_TOWN), MAP_NUM(MAP_DEWFORD_TOWN), HEAL_LOCATION_JOHTO_CHERRYGROVE_CITY},
    [MAPSEC_JOHTO_VIOLET_CITY] = {MAP_GROUP(MAP_LAVARIDGE_TOWN), MAP_NUM(MAP_LAVARIDGE_TOWN), HEAL_LOCATION_JOHTO_VIOLET_CITY},
    [MAPSEC_JOHTO_AZALEA_TOWN] = {MAP_GROUP(MAP_FALLARBOR_TOWN), MAP_NUM(MAP_FALLARBOR_TOWN), HEAL_LOCATION_JOHTO_AZALEA_TOWN},
    [MAPSEC_JOHTO_CIANWOOD_CITY] = {MAP_GROUP(MAP_VERDANTURF_TOWN), MAP_NUM(MAP_VERDANTURF_TOWN), HEAL_LOCATION_JOHTO_CIANWOOD_CITY},
    [MAPSEC_JOHTO_GOLDENROD_CITY] = {MAP_GROUP(MAP_PACIFIDLOG_TOWN), MAP_NUM(MAP_PACIFIDLOG_TOWN), HEAL_LOCATION_JOHTO_GOLDENROD_CITY},
    [MAPSEC_JOHTO_OLIVINE_CITY] = {MAP_GROUP(MAP_PETALBURG_CITY), MAP_NUM(MAP_PETALBURG_CITY), HEAL_LOCATION_JOHTO_OLIVINE_CITY},
    [MAPSEC_JOHTO_ECRUTEAK_CITY] = {MAP_GROUP(MAP_SLATEPORT_CITY), MAP_NUM(MAP_SLATEPORT_CITY), HEAL_LOCATION_JOHTO_ECRUTEAK_CITY},
    [MAPSEC_JOHTO_MAHOGANY_TOWN] = {MAP_GROUP(MAP_MAUVILLE_CITY), MAP_NUM(MAP_MAUVILLE_CITY), HEAL_LOCATION_JOHTO_MAHOGANY_TOWN},
    [MAPSEC_JOHTO_LAKE_OF_RAGE] = {MAP_GROUP(MAP_RUSTBORO_CITY), MAP_NUM(MAP_RUSTBORO_CITY), HEAL_LOCATION_JOHTO_LAKE_OF_RAGE},
    [MAPSEC_JOHTO_BLACKTHORN_CITY] = {MAP_GROUP(MAP_FORTREE_CITY), MAP_NUM(MAP_FORTREE_CITY), HEAL_LOCATION_JOHTO_BLACKTHORN_CITY},
    [MAPSEC_JOHTO_MT_SILVER] = {MAP_GROUP(MAP_LILYCOVE_CITY), MAP_NUM(MAP_LILYCOVE_CITY), HEAL_LOCATION_JOHTO_MT_SILVER},
    [MAPSEC_JOHTO_INDIGO_PLATEAU] = {MAP_GROUP(MAP_MOSSDEEP_CITY), MAP_NUM(MAP_MOSSDEEP_CITY), HEAL_LOCATION_JOHTO_INDIGO_PLATEAU},
    [MAPSEC_JOHTO_MORIYA_SHRINE] = {MAP_GROUP(MAP_SOOTOPOLIS_CITY), MAP_NUM(MAP_SOOTOPOLIS_CITY), HEAL_LOCATION_JOHTO_MORIYA_SHRINE},
    [MAPSEC_JOHTO_SPACE_HYPER_VESSEL] = {MAP_GROUP(MAP_EVER_GRANDE_CITY), MAP_NUM(MAP_EVER_GRANDE_CITY), HEAL_LOCATION_JOHTO_SPACE_HYPER_VESSEL_FRONT},
    [MAPSEC_GENSOKYO_HAKUREI_SHRINE] = {MAP_GROUP(MAP_ROUTE101), MAP_NUM(MAP_ROUTE101), HEAL_LOCATION_GENSOKYO_HAKUREI_SHRINE},
    [MAPSEC_GENSOKYO_HUMAN_VILLAGE] = {MAP_GROUP(MAP_ROUTE102), MAP_NUM(MAP_ROUTE102), HEAL_LOCATION_GENSOKYO_HUMAN_VILLAGE},
    [MAPSEC_GENSOKYO_KOURINDOU] = {MAP_GROUP(MAP_ROUTE103), MAP_NUM(MAP_ROUTE103), HEAL_LOCATION_GENSOKYO_KOURINDOU},
    [MAPSEC_GENSOKYO_MUENZUKA] = {MAP_GROUP(MAP_ROUTE104), MAP_NUM(MAP_ROUTE104), HEAL_LOCATION_GENSOKYO_MUENZUKA},
    [MAPSEC_GENSOKYO_HAKUGYOKUROU] = {MAP_GROUP(MAP_ROUTE105), MAP_NUM(MAP_ROUTE105), HEAL_LOCATION_GENSOKYO_HAKUGYOKUROU},
    [MAPSEC_GENSOKYO_MORIYA_SHRINE] = {MAP_GROUP(MAP_ROUTE106), MAP_NUM(MAP_ROUTE106), HEAL_LOCATION_GENSOKYO_MORIYA_SHRINE},
    [MAPSEC_GENSOKYO_SCARLET_DEVIL_MANSION] = {MAP_GROUP(MAP_ROUTE107), MAP_NUM(MAP_ROUTE107), HEAL_LOCATION_GENSOKYO_SCARLET_DEVIL_MANSION},
    [MAPSEC_GENSOKYO_CHIREIDEN] = {MAP_GROUP(MAP_ROUTE108), MAP_NUM(MAP_ROUTE108), HEAL_LOCATION_GENSOKYO_CHIREIDEN},
    [MAPSEC_GENSOKYO_PALENQUIN_SHIP] = {MAP_GROUP(MAP_ROUTE109), MAP_NUM(MAP_ROUTE109), HEAL_LOCATION_GENSOKYO_PALENQUIN_SHIP},
    [MAPSEC_GENSOKYO_SANZU_RIVER] = {MAP_GROUP(MAP_ROUTE110), MAP_NUM(MAP_ROUTE110), HEAL_LOCATION_GENSOKYO_SANZU_RIVER},
    [MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN] = {MAP_GROUP(MAP_ROUTE111), MAP_NUM(MAP_ROUTE111), HEAL_LOCATION_GENSOKYO_GARDEN_OF_THE_SUN},
    [MAPSEC_JAVA_KEMBANG_TOWN] = {MAP_GROUP(MAP_ROUTE112), MAP_NUM(MAP_ROUTE112), HEAL_LOCATION_JAVA_KEMBANG_TOWN},
    [MAPSEC_GENSOKYO_EIENTEI] = {MAP_GROUP(MAP_ROUTE113), MAP_NUM(MAP_ROUTE113), HEAL_LOCATION_GENSOKYO_EIENTEI},
    [MAPSEC_GENSOKYO_ANIMAL_REALM] = {MAP_GROUP(MAP_ROUTE114), MAP_NUM(MAP_ROUTE114), HEAL_LOCATION_GENSOKYO_ANIMAL_REALM},
    [MAPSEC_JAVA_NEO_BANJAR_CITY] = {MAP_GROUP(MAP_ROUTE115), MAP_NUM(MAP_ROUTE115), HEAL_LOCATION_JAVA_NEO_BANJAR_CITY},
    [MAPSEC_GENSOKYO_FANTASY_WORLD] = {MAP_GROUP(MAP_ROUTE116), MAP_NUM(MAP_ROUTE116), HEAL_LOCATION_GENSOKYO_FANTASY_WORLD},
    [MAPSEC_GENSOKYO_DREAM_WORLD] = {MAP_GROUP(MAP_ROUTE117), MAP_NUM(MAP_ROUTE117), HEAL_LOCATION_GENSOKYO_DREAM_WORLD},
    [MAPSEC_GENSOKYO_MAKAI] = {MAP_GROUP(MAP_ROUTE118), MAP_NUM(MAP_ROUTE118), HEAL_LOCATION_GENSOKYO_MAKAI},
    [MAPSEC_GENSOKYO_LUNAR_CAPITAL] = {MAP_GROUP(MAP_ROUTE119), MAP_NUM(MAP_ROUTE119), HEAL_LOCATION_GENSOKYO_LUNAR_CAPITAL},
    [MAPSEC_GENSOKYO_FANTASY_LEAGUE] = {MAP_GROUP(MAP_ROUTE120), MAP_NUM(MAP_ROUTE120), HEAL_LOCATION_GENSOKYO_FANTASY_LEAGUE},
    [MAPSEC_YYYI_SEA_OF_TREES1] = {MAP_GROUP(MAP_ROUTE121), MAP_NUM(MAP_ROUTE121), HEAL_LOCATION_YYYI_SEA_OF_TREES1},
    [MAPSEC_YYYI_SEA_OF_FLAME1] = {MAP_GROUP(MAP_ROUTE122), MAP_NUM(MAP_ROUTE122), HEAL_LOCATION_YYYI_SEA_OF_FLAME1},
    [MAPSEC_KEY_ILLUSIONARY_WORLD1] = {MAP_GROUP(MAP_ROUTE123), MAP_NUM(MAP_ROUTE123), HEAL_LOCATION_KEY_ILLUSIONARY_WORLD1},
    [MAPSEC_JAVA_YOGYAKARTA] = {MAP_GROUP(MAP_ROUTE124), MAP_NUM(MAP_ROUTE124), HEAL_LOCATION_JAVA_YOGYAKARTA},
    [MAPSEC_JAVA_SOLO] = {MAP_GROUP(MAP_ROUTE125), MAP_NUM(MAP_ROUTE125), HEAL_LOCATION_JAVA_SOLO},
    [MAPSEC_JAVA_SEMARANG] = {MAP_GROUP(MAP_ROUTE126), MAP_NUM(MAP_ROUTE126), HEAL_LOCATION_JAVA_SEMARANG},
    [MAPSEC_JAVA_SURABAYA] = {MAP_GROUP(MAP_ROUTE127), MAP_NUM(MAP_ROUTE127), HEAL_LOCATION_JAVA_SURABAYA},
    [MAPSEC_JAVA_JAKARTA] = {MAP_GROUP(MAP_ROUTE128), MAP_NUM(MAP_ROUTE128), HEAL_LOCATION_JAVA_JAKARTA},
    [MAPSEC_JOHTO_ROUTE_48_POKEMON_CENTER] = {MAP_GROUP(MAP_ROUTE129), MAP_NUM(MAP_ROUTE129), HEAL_LOCATION_JOHTO_ROUTE_48_POKEMON_CENTER},
    [MAPSEC_JOHTO_NOBELESSE_CITY] = {MAP_GROUP(MAP_ROUTE130), MAP_NUM(MAP_ROUTE130), HEAL_LOCATION_JOHTO_NOBELESSE_CITY},
    [MAPSEC_JAVA_MALANG] = {MAP_GROUP(MAP_ROUTE131), MAP_NUM(MAP_ROUTE131), HEAL_LOCATION_JAVA_MALANG},
    [MAPSEC_JAVA_DEVATA_ISLETS] = {MAP_GROUP(MAP_ROUTE132), MAP_NUM(MAP_ROUTE132), HEAL_LOCATION_JAVA_DEVATA_ISLETS},
    [MAPSEC_JAVA_KASEPUHAN_TOWN] = {MAP_GROUP(MAP_ROUTE133), MAP_NUM(MAP_ROUTE133), HEAL_LOCATION_JAVA_KASEPUHAN_TOWN},
    [MAPSEC_JAVA_CILA_PRISON_TOWN] = {MAP_GROUP(MAP_ROUTE134), MAP_NUM(MAP_ROUTE134), HEAL_LOCATION_JAVA_CILA_PRISON_TOWN},
    // Kanto
    /*
...
{
    {
        ...
        .mapSecId = MAPSEC_JOHTO_SPACE_HYPER_VESSEL,
...
static u8 ProcessRegionMapInput_Zoomed(void)
{
    ...
    if (JOY_HELD(DPAD_DOWN) && sRegionMap->scrollY < 0xb4) // 3c
    {
        sRegionMap->zoomedCursorDeltaY = +1;
        input = MAP_INPUT_MOVE_START;
    }
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    case MAP_TYPE_OCEAN_ROUTE:
        ...
        if (sRegionMap->mapSecId == MAPSEC_JOHTO_ROUTE_43 || sRegionMap->mapSecId == MAPSEC_JAVA_SUNAN_PALACE)
    ...
    {
    case MAPSEC_GENSOKYO_ANIMAL_REALM:
        if (y != 0)
            x = 0;
        break;
    case MAPSEC_JAVA_SEMARANG:
    case MAPSEC_JOHTO_ROUTE_26:
        x = 0;
        ...
        if (gSaveBlock1Ptr->pos.y > 56)
            y++;
        break;
    case MAPSEC_YYYI_SEA_OF_TREES1:
        x = 0;
        if (xOnMap > 14)
            x++;
        if (xOnMap > 28)
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_SLATEPORT:
        sRegionMap->mapSecId = MAPSEC_JOHTO_ECRUTEAK_CITY;
        break;
    case SS_TIDAL_LOCATION_LILYCOVE:
        sRegionMap->mapSecId = MAPSEC_JOHTO_MT_SILVER;
        break;
    case SS_TIDAL_LOCATION_ROUTE124:
        sRegionMap->mapSecId = MAPSEC_JAVA_YOGYAKARTA;
        break;
    case SS_TIDAL_LOCATION_ROUTE131:
        sRegionMap->mapSecId = MAPSEC_JAVA_MALANG;
        break;
    default:
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_JOHTO_NEW_BARK_TOWN:
    ...
    case MAPSEC_JOHTO_ECRUTEAK_CITY:
    ...
    case MAPSEC_GENSOKYO_HAKUREI_SHRINE:
        return FlagGet(FLAG_VISITED_GENSOKYO_HAKUREI_SHRINE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_HUMAN_VILLAGE:
        return FlagGet(FLAG_VISITED_GENSOKYO_HUMAN_VILLAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_KOURINDOU:
        return FlagGet(FLAG_VISITED_GENSOKYO_KOURINDOU) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_MUENZUKA:
        return FlagGet(FLAG_VISITED_GENSOKYO_MUENZUKA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_HAKUGYOKUROU:
        return FlagGet(FLAG_VISITED_GENSOKYO_HAKUGYOKUROU) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_MORIYA_SHRINE:
        return FlagGet(FLAG_VISITED_GENSOKYO_MORIYA_SHRINE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_SCARLET_DEVIL_MANSION:
        return FlagGet(FLAG_VISITED_GENSOKYO_SCARLET_DEVIL_MANSION) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_CHIREIDEN:
        return FlagGet(FLAG_VISITED_GENSOKYO_CHIREIDEN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_PALENQUIN_SHIP:
        return FlagGet(FLAG_VISITED_GENSOKYO_PALENQUIN_SHIP) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_SANZU_RIVER:
        return FlagGet(FLAG_VISITED_GENSOKYO_SANZU_RIVER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN:
        return FlagGet(FLAG_VISITED_GENSOKYO_GARDEN_OF_THE_SUN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_KEMBANG_TOWN:
        return FlagGet(FLAG_VISITED_JAVA_KEMBANG_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_EIENTEI:
        return FlagGet(FLAG_VISITED_GENSOKYO_EIENTEI) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_ANIMAL_REALM:
        return FlagGet(FLAG_VISITED_GENSOKYO_ANIMAL_REALM) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_NEO_BANJAR_CITY:
        return FlagGet(FLAG_VISITED_JAVA_NEO_BANJAR_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_FANTASY_WORLD:
        return FlagGet(FLAG_VISITED_GENSOKYO_FANTASY_WORLD) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_DREAM_WORLD:
        return FlagGet(FLAG_VISITED_GENSOKYO_DREAM_WORLD) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_MAKAI:
        return FlagGet(FLAG_VISITED_GENSOKYO_MAKAI) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_LUNAR_CAPITAL:
        return FlagGet(FLAG_VISITED_GENSOKYO_LUNAR_CAPITAL) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GENSOKYO_FANTASY_LEAGUE:
        return FlagGet(FLAG_VISITED_GENSOKYO_FANTASY_LEAGUE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_YYYI_SEA_OF_TREES1:
        return FlagGet(FLAG_VISITED_YYYI_SEA_OF_TREES1) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_YYYI_SEA_OF_FLAME1:
        return FlagGet(FLAG_VISITED_YYYI_SEA_OF_FLAME1) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_KEY_ILLUSIONARY_WORLD1:
        return FlagGet(FLAG_VISITED_KEY_ILLUSIONARY_WORLD1) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_YOGYAKARTA:
        return FlagGet(FLAG_VISITED_JAVA_YOGYAKARTA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_SOLO:
        return FlagGet(FLAG_VISITED_JAVA_SOLO) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_SEMARANG:
        return FlagGet(FLAG_VISITED_JAVA_SEMARANG) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_SURABAYA:
        return FlagGet(FLAG_VISITED_JAVA_SURABAYA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_JAKARTA:
        return FlagGet(FLAG_VISITED_JAVA_JAKARTA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JOHTO_ROUTE_48_POKEMON_CENTER:
        return FlagGet(FLAG_VISITED_JOHTO_ROUTE_48_POKEMON_CENTER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JOHTO_NOBELESSE_CITY:
        return FlagGet(FLAG_VISITED_JOHTO_NOBELESSE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_MALANG:
        return FlagGet(FLAG_VISITED_JAVA_MALANG) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_DEVATA_ISLETS:
        return FlagGet(FLAG_VISITED_JAVA_DEVATA_ISLETS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_KASEPUHAN_TOWN:
        return FlagGet(FLAG_VISITED_JAVA_KASEPUHAN_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JAVA_CILA_PRISON_TOWN:
        return FlagGet(FLAG_VISITED_JAVA_CILA_PRISON_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
/*
...
{
    if (mapSecId == MAPSEC_JOHTO_ROUTE_40)
...
{
    {
        ...
        .mapsec = MAPSEC_JOHTO_TWINRIVER_CITY,
        .flag = FLAG_VISITED_LITTLEROOT_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_NEW_BARK_TOWN,
        .flag = FLAG_VISITED_OLDALE_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_CHERRYGROVE_CITY,
        .flag = FLAG_VISITED_DEWFORD_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_VIOLET_CITY,
        .flag = FLAG_VISITED_LAVARIDGE_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_AZALEA_TOWN,
        .flag = FLAG_VISITED_FALLARBOR_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_CIANWOOD_CITY,
        .flag = FLAG_VISITED_VERDANTURF_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_GOLDENROD_CITY,
        .flag = FLAG_VISITED_PACIFIDLOG_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_OLIVINE_CITY,
        .flag = FLAG_VISITED_PETALBURG_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_ECRUTEAK_CITY,
        .flag = FLAG_VISITED_SLATEPORT_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_MAHOGANY_TOWN,
        .flag = FLAG_VISITED_MAUVILLE_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_LAKE_OF_RAGE,
        .flag = FLAG_VISITED_RUSTBORO_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_BLACKTHORN_CITY,
        .flag = FLAG_VISITED_FORTREE_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_MT_SILVER,
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_MORIYA_SHRINE,
        .flag = FLAG_VISITED_SOOTOPOLIS_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_SPACE_HYPER_VESSEL,
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_HAKUREI_SHRINE,
        .flag = FLAG_VISITED_GENSOKYO_HAKUREI_SHRINE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_HUMAN_VILLAGE,
        .flag = FLAG_VISITED_GENSOKYO_HUMAN_VILLAGE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_KOURINDOU,
        .flag = FLAG_VISITED_GENSOKYO_KOURINDOU,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_MUENZUKA,
        .flag = FLAG_VISITED_GENSOKYO_MUENZUKA,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_HAKUGYOKUROU,
        .flag = FLAG_VISITED_GENSOKYO_HAKUGYOKUROU,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_MORIYA_SHRINE,
        .flag = FLAG_VISITED_GENSOKYO_MORIYA_SHRINE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_SCARLET_DEVIL_MANSION,
        .flag = FLAG_VISITED_GENSOKYO_SCARLET_DEVIL_MANSION,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_CHIREIDEN,
        .flag = FLAG_VISITED_GENSOKYO_CHIREIDEN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_PALENQUIN_SHIP,
        .flag = FLAG_VISITED_GENSOKYO_PALENQUIN_SHIP,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_SANZU_RIVER,
        .flag = FLAG_VISITED_GENSOKYO_SANZU_RIVER,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_GARDEN_OF_THE_SUN,
        .flag = FLAG_VISITED_GENSOKYO_GARDEN_OF_THE_SUN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_KEMBANG_TOWN,
        .flag = FLAG_VISITED_JAVA_KEMBANG_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_EIENTEI,
        .flag = FLAG_VISITED_GENSOKYO_EIENTEI,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_ANIMAL_REALM,
        .flag = FLAG_VISITED_GENSOKYO_ANIMAL_REALM,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_NEO_BANJAR_CITY,
        .flag = FLAG_VISITED_JAVA_NEO_BANJAR_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_FANTASY_WORLD,
        .flag = FLAG_VISITED_GENSOKYO_FANTASY_WORLD,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_DREAM_WORLD,
        .flag = FLAG_VISITED_GENSOKYO_DREAM_WORLD,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_MAKAI,
        .flag = FLAG_VISITED_GENSOKYO_MAKAI,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_LUNAR_CAPITAL,
        .flag = FLAG_VISITED_GENSOKYO_LUNAR_CAPITAL,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_GENSOKYO_FANTASY_LEAGUE,
        .flag = FLAG_VISITED_GENSOKYO_FANTASY_LEAGUE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_YYYI_SEA_OF_TREES1,
        .flag = FLAG_VISITED_YYYI_SEA_OF_TREES1,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_YYYI_SEA_OF_FLAME1,
        .flag = FLAG_VISITED_YYYI_SEA_OF_FLAME1,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_KEY_ILLUSIONARY_WORLD1,
        .flag = FLAG_VISITED_KEY_ILLUSIONARY_WORLD1,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_YOGYAKARTA,
        .flag = FLAG_VISITED_JAVA_YOGYAKARTA,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_SOLO,
        .flag = FLAG_VISITED_JAVA_SOLO,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_SEMARANG,
        .flag = FLAG_VISITED_JAVA_SEMARANG,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_SURABAYA,
        .flag = FLAG_VISITED_JAVA_SURABAYA,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_JAKARTA,
        .flag = FLAG_VISITED_JAVA_JAKARTA,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_ROUTE_48_POKEMON_CENTER,
        .flag = FLAG_VISITED_JOHTO_ROUTE_48_POKEMON_CENTER,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JOHTO_NOBELESSE_CITY,
        .flag = FLAG_VISITED_JOHTO_NOBELESSE_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_MALANG,
        .flag = FLAG_VISITED_JAVA_MALANG,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_DEVATA_ISLETS,
        .flag = FLAG_VISITED_JAVA_DEVATA_ISLETS,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_KASEPUHAN_TOWN,
        .flag = FLAG_VISITED_JAVA_KASEPUHAN_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_JAVA_CILA_PRISON_TOWN,
        .flag = FLAG_VISITED_JAVA_CILA_PRISON_TOWN,
    },
/*
    {
